...
type Props = {
    ...
    onClose: () => void,
    onConfirm: (arg1?: LocationValue | null | undefined) => void,
    open: boolean,
...
class LocationOverlay extends React.Component<Props> {
    ...
    map: typeof Map | null | undefined;
    geolocatorSelectionStore: SingleSelectionStore<string>;
    updateDataOnGeolocatorSelectDisposer: () => any;
    updateDataOnOpenDisposer: () => any;
    ...
    @action handleAutoCompleteChange = (data: any) => {
        if (!data) {
            return;
        }
    ...
    @action handleMapZoom = (event: any) => {
        this.zoom = event.zoom;
    };

    @action handleMarkerDrag = (event: any) => {
    ...
    @action handleTitleChange = (title?: string | null) => {
        this.title = title;
    };

    @action handleStreetChange = (street?: string | null) => {
        this.street = street;
    };

    @action handleNumberChange = (number?: string | null) => {
        this.number = number;
    };

    @action handleCodeChange = (code?: string | null) => {
        this.code = code;
    };

    @action handleTownChange = (town?: string | null) => {
        this.town = town;
    };

    @action handleCountryChange = (country?: string | null) => {
        this.country = country;
    };

    @action handleLatChange = (lat?: number | null) => {
        this.lat = lat;
        this.updateMapToData();
    };

    @action handleLongChange = (long?: number | null) => {
        this.long = long;
        this.updateMapToData();
    };

    @action handleZoomChange = (zoom?: number | null) => {
        this.zoom = zoom || 1;
        this.updateMapToData();
    };
