...
const Location_1 = __importDefault(require("../../../containers/Location"));
let Location = (() => {
    ...
    var Location = _classThis = class extends _classSuper {
        ...
        render() {
            ...
            return (<Location_1.default disabled={!!disabled} locale={this.locale.get()} onChange={this.handleChange} value={value}/>);
        }
        get locale() {
