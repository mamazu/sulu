...
class Search extends React.Component<Props> {
    @observable
    query: string | null | undefined = undefined;
    @observable
    indexes: {
        [indexName: string]: Index
    } | null | undefined = undefined;
    @observable
    indexName: string | null | undefined = undefined;
    ...
    @action componentDidMount() {
        ...
        indexStore.loadIndexes().then(action((indexes: Array<Index>) => {
            this.indexes = indexes.reduce<Record<string, any>>((indexesObject: any, index) => {
    ...
    @action handleIndexChange = (indexName?: string | null) => {
    ...
    handleResultClick = (index: number) => {
        ...
        router.navigate(
            routeName,
            Object.keys(resultToRoute).reduce<Record<string, any>>((parameters, resultPath) => {
