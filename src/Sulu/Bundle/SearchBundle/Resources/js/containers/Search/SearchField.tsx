...
type Props = {
    ...
    onIndexChange: (indexName?: string | null | undefined) => void,
...
class SearchField extends React.Component<Props> {
    ...
    @computed
    get allIndexes(): Array<Index> | null | undefined {
        ...
        return Object.values(indexes) as any;
    }

    @computed
    get index(): Index | null | undefined {
    ...
    @action handleIndexChange = (value?: string | null) => {
