...
type Props<T extends string | number> = {
    ...
    children: ChildrenArray<Element<typeof Header | typeof Body> | null | undefined>,
    onAllSelectionChange?: (checked: boolean) => void | null | undefined,
    onRowCollapse?: (rowId: T) => void,
    onRowExpand?: (rowId: T) => void,
    onRowSelectionChange?: (rowId: T, selected?: boolean) => void | null | undefined,
...
@observer
class Table<T extends string | number> extends React.Component<Props<T>> {
    static defaultProps = {
        buttons: [],
        selectMode: 'none',
        skin: 'dark',
    ...
    cloneHeader = (originalHeader: Element<typeof Header> | null | undefined, allSelected: boolean) => {
        if (!originalHeader) {
            return null;
        }
    ...
    render() {
        ...
        React.Children
            .forEach(children, (child?: Element<typeof Header | typeof Body> | null) => {
                if (!child) {
                    return;
                }
