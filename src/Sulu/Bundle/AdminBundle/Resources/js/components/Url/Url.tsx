...
type Props = {
    ...
    onProtocolChange?: (protocol?: string | null | undefined) => void,
...
class Url extends React.Component<Props> {
    ...
    @action handlePathChange = (event: React.SyntheticEvent<HTMLInputElement>) => {
