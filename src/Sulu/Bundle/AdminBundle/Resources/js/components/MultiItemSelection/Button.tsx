...
type Props<T> = (ButtonConfig<T>) & {
    location: 'left' | 'right'
};

@observer
class Button<T extends string | number> extends React.Component<Props<T>> {
    @observable
    open: boolean = false;
    ...
    handleOptionClick: (option?: T | null | undefined) => void = (option?: T | null) => {
