...
type Props<T, U, V, W> = {
    ...
    leftButton?: Button<U>,
    loading: boolean,
    onItemClick?: (itemId: T, value?: W | null | undefined) => void,
...
class MultiItemSelection<T, U extends string | number, V extends string | number, W> extends React.PureComponent<Props<T, U, V, W>> {
    static defaultProps = {
        disabled: false,
        loading: false,
        sortable: true,
