...
type Props = {
    ...
    onItemDoubleClick?: (id: string | number) => void | null | undefined,
    toolbarItemsProvider: (index: number) => Array<ToolbarItemConfig> | null | undefined
};
...
class ColumnList extends React.Component<Props> {
    ...
    setContainerRef = (ref?: ElementRef<'div'> | null) => {
        if (!ref) {
            return;
        }
    ...
    setToolbarRef = (ref?: ElementRef<'div'> | null) => {
        if (!ref) {
            return;
        }
