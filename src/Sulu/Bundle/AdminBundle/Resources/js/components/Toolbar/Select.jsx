...
let Select = (() => {
    ...
    var Select = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
            this.handleOptionClick = (__runInitializers(this, _instanceExtraInitializers), (option) => {
        ...
        render() {
            ...
            return (<Popover_1.default className={className} disabled={disabled} icon={icon} label={showText ? buttonValue : undefined} loading={loading} size={size} skin={skin}>
                {(onClose) => (<OptionList_1.default onClose={onClose} onOptionClick={this.handleOptionClick} options={options} size={size} skin={skin} value={value}/>)}
            </Popover_1.default>);
        }
    };
    ...
    (() => {
        ...
        _get_selectedOption_decorators = [mobx_1.computed];
