...
const Translator_1 = require("../../../utils/Translator/Translator");
...
test('Render a Breadcrumb', () => {
    const blockToolbar = (0, enzyme_1.render)(<BlockToolbar_1.default actions={[
            {
                label: 'Copy',
                icon: 'su-copy',
                handleClick: jest.fn(),
        ...
        ]} allSelected={true} onCancel={jest.fn()} onSelectAll={jest.fn()} onUnselectAll={jest.fn()} selectedCount={2}/>);
    expect(blockToolbar).toMatchSnapshot();
});
test('Click cancel button', () => {
    const clickSpy = jest.fn();
    const blockToolbar = (0, enzyme_1.shallow)(<BlockToolbar_1.default actions={[
            {
                label: 'Copy',
                icon: 'su-copy',
                handleClick: jest.fn(),
        ...
        ]} allSelected={true} onCancel={clickSpy} onSelectAll={jest.fn()} onUnselectAll={jest.fn()} selectedCount={2}/>);
...
test('Click select all button', () => {
    ...
    const blockToolbar = (0, enzyme_1.shallow)(<BlockToolbar_1.default actions={[
        ...
        ]} allSelected={false} onCancel={jest.fn()} onSelectAll={clickSpy} onUnselectAll={jest.fn()} selectedCount={2}/>);
...
test('Click un select all button', () => {
    ...
    const blockToolbar = (0, enzyme_1.shallow)(<BlockToolbar_1.default actions={[
        ...
        ]} allSelected={true} onCancel={jest.fn()} onSelectAll={jest.fn()} onUnselectAll={clickSpy} selectedCount={2}/>);
    blockToolbar.find('Checkbox').at(0).simulate('change');
    expect(clickSpy).toHaveBeenCalled();
});
