...
export default function withContainerSize(Component: ComponentType<any>, containerClass: string = styles.container) {
    @observer
    class WithContainerSizeComponent extends React.Component<any> {
        ...
        readContainerDimensions = (container?: ElementRef<'div'> | null) => {
