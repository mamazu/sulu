...
type Props = {
    ...
    onChange: (value?: SelectionData | null | undefined) => void,
    usePercentageValues: boolean,
    value: SelectionData | typeof undefined
};

export default function withPercentageValues(Component: ComponentType<any>) {
    @observer
    class WithPercentageValuesComponent extends React.Component<Props> {
        ...
        handleChange = (value?: SelectionData | null) => {
