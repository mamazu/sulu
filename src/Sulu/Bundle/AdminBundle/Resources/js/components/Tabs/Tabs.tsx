...
class Tabs extends React.Component<Props> {
    ...
    tabsWidth: number = 0;
    @observable
    tabsContainerWrapperWidth: number = 0;
    @observable
    tabsContainerWidth: number = 0;

    @observable
    tabWidths: Map<number, number> = new Map();
    @observable
    tabRefs: Map<number, ElementRef<'li'> | null | undefined> = new Map();
    @observable dropdownOpen = false;
    @observable
    lastSelectedIndex: number | null | undefined;

    static Tab = Tab;

    resizeObserver: ResizeObserver | null | undefined;

    tabsRef: ElementRef<'div'> | null | undefined;
    tabsContainerWrapperRef: ElementRef<'div'> | null | undefined;
    tabsContainerRef: ElementRef<'ul'> | null | undefined;
    dropdownButtonRef: ElementRef<'button'> | null | undefined;
    ...
    setTabsRef = (ref?: ElementRef<'div'> | null) => {
        this.tabsRef = ref;
    };

    setTabsContainerWrapperRef = (ref?: ElementRef<'div'> | null) => {
        this.tabsContainerWrapperRef = ref;
    };

    setTabsContainerRef = (ref?: ElementRef<'ul'> | null) => {
        this.tabsContainerRef = ref;
    };

    setDropdownButtonRef = (ref?: ElementRef<'button'> | null) => {
    ...
    @action setTabRef = (index: number, ref?: ElementRef<'li'> | null) => {
    ...
    @computed
    get collapsedTabIndices(): number[] {
