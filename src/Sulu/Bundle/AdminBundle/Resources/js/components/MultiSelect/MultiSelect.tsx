...
export default class MultiSelect<T extends string | number> extends React.PureComponent<Props<T>> {
    static defaultProps = {
        disabled: false,
        skin: 'default',
        values: [],
    ...
    isOptionSelected: (option: Element<Flow.Class<MultiSelect.Option<T>>>) => boolean = (option) => {
