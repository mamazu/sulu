...
class SingleAutoComplete extends React.Component<Props> {
    ...
    @observable
    inputContainerRef: ElementRef<any>;

    @observable displaySuggestions = false;
    @observable
    inputValue: string | null | undefined = this.props.value ? this.props.value[this.props.displayProperty] : undefined;
    ...
    @action setInputValue(value?: string | null) {
        this.inputValue = value;
    }

    @action setInputContainerRef = (inputContainerRef?: ElementRef<any> | null) => {
    ...
    handleInputChange = (value?: string | null) => {
        if (!value) {
