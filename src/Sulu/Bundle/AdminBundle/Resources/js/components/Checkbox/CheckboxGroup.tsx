...
export default class CheckboxGroup<T extends string | number> extends React.PureComponent<Props<T>> {
    static defaultProps = {
        disabled: false,
    };

    handleChange: (checked: boolean, changedValue?: T | null | undefined) => void = (checked, changedValue) => {
