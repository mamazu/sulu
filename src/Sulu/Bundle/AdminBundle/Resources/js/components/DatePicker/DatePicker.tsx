...
type Props = {
    ...
    options: {
        dateFormat?: string | null | undefined | boolean,
        timeFormat?: string | null | undefined | boolean
    },
    placeholder?: string,
    valid: boolean,
...
class DatePicker extends React.Component<Props> {
    ...
    @observable
    value: string | null | undefined | Date | null | undefined | Moment | null | undefined = null;
    @observable
    inputRef: ElementRef<any> | null | undefined;

    @action setOpen(open: boolean) {
        this.open = open;
    }

    @action setValue(value: string | null | undefined | Date | null | undefined | Moment | null | undefined) {
        this.value = value;
    }
    ...
    @action setInputRef = (ref?: ElementRef<any> | null) => {
        this.inputRef = ref;
    };
    ...
    getInputChange = (props: any) => {
        return (value: string | null | undefined, event: React.SyntheticEvent<HTMLInputElement>) => {
