...
class MultiAutoComplete extends React.Component<Props> {
    ...
    @action setInputRef = (ref?: ElementRef<'input'> | null) => {
    ...
    @action handleInputChange = (event: React.SyntheticEvent<HTMLInputElement>) => {
    ...
    @action handleSelect = (newValue: any) => {
        const {
            onChange,
            onFinish,
            value,
