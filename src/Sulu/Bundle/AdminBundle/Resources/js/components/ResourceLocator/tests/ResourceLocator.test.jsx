...
test('ResourceLocator should render with type full', () => {
    ...
    expect((0, enzyme_1.render)(<ResourceLocator_1.default locale={locale} mode="full" onBlur={jest.fn()} onChange={onChange} value={value}/>)).toMatchSnapshot();
});
test('ResourceLocator should render with type full and a value of undefined', () => {
    const onChange = jest.fn();
    const locale = mobx_1.observable.box('en');
    expect((0, enzyme_1.render)(<ResourceLocator_1.default locale={locale} mode="full" onBlur={jest.fn()} onChange={onChange} value={undefined}/>)).toMatchSnapshot();
});
test('ResourceLocator should render with type leaf', () => {
    const onChange = jest.fn();
    const value = '/parent/child';
    const locale = mobx_1.observable.box('en');
    expect((0, enzyme_1.render)(<ResourceLocator_1.default locale={locale} mode="leaf" onBlur={jest.fn()} onChange={onChange} value={value}/>)).toMatchSnapshot();
});
test('ResourceLocator should render with type leaf and a value of undefined', () => {
    const onChange = jest.fn();
    const locale = mobx_1.observable.box('en');
    expect((0, enzyme_1.render)(<ResourceLocator_1.default locale={locale} mode="leaf" onBlur={jest.fn()} onChange={onChange} value={undefined}/>)).toMatchSnapshot();
});
test('ResourceLocator should render when disabled', () => {
    const onChange = jest.fn();
    const value = '/parent';
    const locale = mobx_1.observable.box('en');
    expect((0, enzyme_1.render)(<ResourceLocator_1.default disabled={true} locale={locale} mode="full" onBlur={jest.fn()} onChange={onChange} value={value}/>)).toMatchSnapshot();
});
test('ResourceLocator should update the split leaf representation when value changes', () => {
    const locale = mobx_1.observable.box('en');
    const resourceLocator = (0, enzyme_1.mount)(<ResourceLocator_1.default locale={locale} mode="leaf" onBlur={jest.fn()} onChange={jest.fn()} value="/child"/>);
...
test('ResourceLocator should call the onChange callback when the input changes with type full', () => {
    ...
    const value = '/parent';
    const locale = mobx_1.observable.box('en');
    const resourceLocator = (0, enzyme_1.mount)(<ResourceLocator_1.default locale={locale} mode="full" onBlur={jest.fn()} onChange={onChange} value={value}/>);
...
test('ResourceLocator should call the onChange callback when the input changes with type leaf', () => {
    ...
    const value = '/parent/child';
    const locale = mobx_1.observable.box('en');
    const resourceLocator = (0, enzyme_1.mount)(<ResourceLocator_1.default locale={locale} mode="leaf" onBlur={jest.fn()} onChange={onChange} value={value}/>);
...
test('ResourceLocator should replace capital letters even when given locale is not a valid BCP 47 code', () => {
    const onChange = jest.fn();
    const value = '/parent/child';
    const locale = mobx_1.observable.box('de_CH');
    const resourceLocator = (0, enzyme_1.mount)(<ResourceLocator_1.default locale={locale} mode="leaf" onBlur={jest.fn()} onChange={onChange} value={value}/>);
    resourceLocator.find('Input').props().onChange('CHILD');
    expect(onChange).toBeCalledWith('/parent/child');
});
...
test('ResourceLocator should call the onChange callback with undefined if no input is given', () => {
    const onChange = jest.fn();
    const locale = mobx_1.observable.box('en');
    const resourceLocator = (0, enzyme_1.mount)(<ResourceLocator_1.default locale={locale} mode="leaf" onChange={onChange} value="/url"/>);
...
test('ResourceLocator should call the onBlur callback when the Input finishes editing', () => {
    ...
    const locale = mobx_1.observable.box('en');
    const resourceLocator = (0, enzyme_1.shallow)(<ResourceLocator_1.default locale={locale} mode="leaf" onBlur={finishSpy} onChange={jest.fn()} value="/some/url"/>);
