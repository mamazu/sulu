...
const Divider = Select_1.default.Divider;
test('The component should render with a dark skin', () => {
    const isOptionSelected = jest.fn().mockReturnValue(false);
    const select = (0, enzyme_1.mount)(<Select_1.default displayValue="My text" icon="su-plus" isOptionSelected={isOptionSelected} onSelect={jest.fn()} skin="dark">
            <Option_1.default value="option-1">Option 1</Option_1.default>
            <Option_1.default value="option-2">Option 2</Option_1.default>
            <Divider />
            <Option_1.default value="option-3">Option 3</Option_1.default>
        </Select_1.default>);
...
test('The component should show a disabled select when disabled', () => {
    ...
    const select = (0, enzyme_1.mount)(<Select_1.default disabled={true} displayValue="My text" icon="su-plus" isOptionSelected={isOptionSelected} onSelect={onSelect}>
            <Option_1.default value="option-1">Option 1</Option_1.default>
            <Option_1.default value="option-2">Option 2</Option_1.default>
            <Divider />
            <Option_1.default value="option-3">Option 3</Option_1.default>
...
test('The component should not open the popover on display-value-click when disabled', () => {
    const isOptionSelected = jest.fn().mockReturnValue(false);
    const onSelect = jest.fn();
    const select = (0, enzyme_1.mount)(<Select_1.default disabled={true} displayValue="My text" isOptionSelected={isOptionSelected} onSelect={onSelect}>
            <Option_1.default value="option-1">Option 1</Option_1.default>
            <Option_1.default value="option-2">Option 2</Option_1.default>
            <Divider />
            <Option_1.default value="option-3">Option 3</Option_1.default>
...
test('The component should trigger the select callback and close the popover when an option is clicked', () => {
    const onSelect = jest.fn();
    const isOptionSelected = jest.fn().mockReturnValue(false);
    const select = (0, enzyme_1.mount)(<Select_1.default displayValue="My text" isOptionSelected={isOptionSelected} onSelect={onSelect}>
            <Option_1.default value="option-1">Option 1</Option_1.default>
            <Option_1.default value="option-2">Option 2</Option_1.default>
            <Divider />
            <Option_1.default value="option-3">Option 3</Option_1.default>
...
test('The component should call the onClose callback when it is closing', () => {
    ...
    const isOptionSelected = jest.fn().mockReturnValue(false);
    const select = (0, enzyme_1.mount)(<Select_1.default displayValue="My text" isOptionSelected={isOptionSelected} onClose={closeSpy} onSelect={jest.fn()}>
            <Option_1.default value="option-1">Option 1</Option_1.default>
            <Option_1.default value="option-2">Option 2</Option_1.default>
        </Select_1.default>);
    select.instance().handleDisplayValueClick();
...
test('The component should pass the centered child node to the popover', () => {
    ...
    const selectedOption = (<Option_1.default value="option-3">Option 3</Option_1.default>);
    const select = (0, enzyme_1.mount)(<Select_1.default displayValue="My text" isOptionSelected={isOptionSelected} onSelect={onSelect}>
            <Option_1.default value="option-1">Option 1</Option_1.default>
            <Option_1.default value="option-2">Option 2</Option_1.default>
            <Divider />
    ...
    expect(popover.props().centerChildNode).toBe((0, enzyme_1.mount)(selectedOption).get(0).innerHTML);
});
...
test('The component should set the current selected element as first focused element', () => {
    ...
    const option2 = (<Option_1.default value="option-2">Option 2</Option_1.default>);
    const select = (0, enzyme_1.mount)(<Select_1.default displayValue="My text" isOptionSelected={isOptionSelected} onSelect={onSelect}>
            <Option_1.default value="option-1">Option 1</Option_1.default>
            {option2}
            <Divider />
...
test('The component should focus children matching keyboard input', () => {
    ...
    const isOptionSelected = jest.fn().mockReturnValue(false);
    const select = (0, enzyme_1.mount)(<Select_1.default displayValue="My text" isOptionSelected={isOptionSelected} onSelect={onSelect}>
            <Option_1.default value="option-abc">ABC</Option_1.default>
            <Option_1.default value="option-def">DEF</Option_1.default>
            <Option_1.default value="option-ghi">GHI</Option_1.default>
        </Select_1.default>);
    select.instance().handleDisplayValueClick();
    select.update();
