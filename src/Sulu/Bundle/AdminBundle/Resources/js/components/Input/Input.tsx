...
export default class Input<T extends string | null | undefined | number | null | undefined> extends React.PureComponent<InputProps<T>> {
    static defaultProps = {
        alignment: 'left',
        autoFocus: false,
        collapsed: false,
    ...
    setInputContainerRef = (ref?: ElementRef<any> | null) => {
