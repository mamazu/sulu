...
import type {ChildrenArray, ReactNode, ElementRef} from 'react';
...
export default class Masonry extends React.PureComponent<Props> {
    masonryRef: ElementRef<'ul'> | null | undefined;
    ...
    setMasonryRef = (ref?: ElementRef<'ul'> | null) => {
        this.masonryRef = ref;
    };
    ...
    cloneItems(originalItems?: ChildrenArray<any> | null) {
        const itemStyle = {marginBottom: MASONRY_OPTIONS.gutter} as const;
