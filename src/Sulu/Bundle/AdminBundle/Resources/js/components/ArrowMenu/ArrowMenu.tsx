...
class ArrowMenu extends React.Component<Props> {
    ...
    @observable
    displayValueRef: ElementRef<any> | null | undefined;

    @action setDisplayValueRef = (ref?: ElementRef<any> | null) => {
        this.displayValueRef = ref;
    };

    cloneAnchorElement = (anchorElement: Element<any>) => {
    ...
    cloneChildren(children: ChildrenArray<Element<any> | false>) {
    ...
    renderMenu(
        setPopoverElementRef: (ref: ElementRef<any>) => void,
        popoverStyle: any,
