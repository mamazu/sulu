...
let DropdownButton = (() => {
    ...
    var DropdownButton = _classThis = class extends _classSuper {
        render() {
            ...
            const button = (<Button_1.default className={className} icon={icon} onClick={this.handleButtonClick} showDropdownIcon={true} skin={skin}>
                {label}
            </Button_1.default>);
            return (<ArrowMenu_1.default anchorElement={button} onClose={this.handleArrowMenuClose} open={this.open} refProp="buttonRef">
        ...
        constructor() {
            ...
            this.handleArrowMenuClose = (__runInitializers(this, _handleButtonClick_extraInitializers), __runInitializers(this, _handleArrowMenuClose_initializers, () => {
                this.open = false;
            }));
            __runInitializers(this, _handleArrowMenuClose_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "DropdownButton");
    (() => {
        var _a;
    ...
    _classThis.Item = ArrowMenu_1.default.Action;
    (() => {
