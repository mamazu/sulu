...
export default class SingleSelect<T extends string | number> extends React.PureComponent<Props<T>> {
    static defaultProps = {
        disabled: false,
        skin: 'default',
    };
    ...
    isOptionSelected: (option: Element<Flow.Class<SingleSelect.Option<T>>>) => boolean = (option) => {
