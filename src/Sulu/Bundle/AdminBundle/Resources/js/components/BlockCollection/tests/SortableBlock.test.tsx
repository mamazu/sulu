...
jest.mock('react-sortable-hoc', () => ({
    SortableContainer: jest.fn().mockImplementation((component: any) => component),
    SortableElement: jest.fn().mockImplementation((component: any) => component),
    SortableHandle: jest.fn().mockImplementation((component: any) => component),
}));
...
test('Render expanded sortable, non-collapsable block with types', () => {
    const renderBlockContent = jest.fn().mockImplementation(
        (value: any, type: any) => 'Test for ' + value.content + (type ? ' and type ' + type : '')
    );
...
test('Should call renderBlockContent with the correct arguments', () => {
    ...
    const value = {content: 'Test 1'} as const;
...
test('Should call renderBlockContent with the correct arguments when types are involved', () => {
    const renderBlockContentSpy = jest.fn();
    const value = {content: 'Test 2'} as const;
