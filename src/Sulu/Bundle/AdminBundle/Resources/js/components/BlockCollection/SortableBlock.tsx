...
@observer
class SortableBlock<T extends string, U extends {
    type: T
    ...
    @computed
    get actions(): Array<ActionConfig> {
...
const SortableElementBlock: ComponentType<Props<any, any>> = SortableElement(SortableBlock);
