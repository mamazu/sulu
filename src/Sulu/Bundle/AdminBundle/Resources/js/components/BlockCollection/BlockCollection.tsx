...
type Props<T extends string, U extends {
    type: T
}> = {
    addButtonText?: string | null | undefined,
    collapsable: boolean,
    defaultType: T,
    disabled: boolean,
    ...
    pasteButtonText?: string | null | undefined,
    renderBlockContent: RenderBlockContentCallback<T, U>,
    types?: Partial<Record<T, string>>,
    value: Array<U>
};
...
@observer
class BlockCollection<T extends string, U extends {
    type: T
}> extends React.Component<Props<T, U>> {
    static idCounter = 0;
    ...
    @observable
    mode: BlockMode = 'sortable';

    fillArraysDisposer: () => any | null | undefined;
    setPasteableBlocksDisposer: () => any | null | undefined;
    ...
    @computed
    get selectedBlockIndexes(): Array<number> {
        const indexes = [];
