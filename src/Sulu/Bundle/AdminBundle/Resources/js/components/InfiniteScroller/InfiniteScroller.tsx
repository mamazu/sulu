...
export default class InfiniteScroller extends React.PureComponent<Props> {
    ...
    elementRef: ElementRef<'section'> | null | undefined;
    ...
    getScrollContainer(parentContainer: ElementRef<any>) {
    ...
    isScrollable(el: ElementRef<any>): boolean {
        const overflowY = window.getComputedStyle(el)['overflow-y'];

        return overflowY === 'auto' || overflowY === 'scroll';
    }

    setRef = (ref?: ElementRef<'section'> | null) => {
        this.elementRef = ref;
    };
