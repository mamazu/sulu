...
class PopoverPositioner {
    static dimensionsToStyle(dimensions) {
        const style = {
    ...
    static getCroppedDimensions(popoverWidth, popoverHeight, anchorTop, anchorLeft, anchorWidth, anchorHeight, horizontalOffset, verticalOffset, centerChildOffsetTop, alignOnVerticalAnchorEdges = true) {
    ...
    static cropVerticalDimensions(dimensions, windowHeight) {
    ...
    static cropHorizontalDimensions(dimensions, windowWidth, popoverWidth, anchorLeft, anchorWidth) {
        const newDimensions = Object.assign({}, dimensions);
