...
type Props = {
    ...
    backdrop: boolean,
    centerChildElement?: ElementRef<any>,
    children?: (
    ...
    onClose?: () => void,
    open: boolean,
    popoverChildRef?: (ref?: ElementRef<any> | null | undefined) => void,
...
class Popover extends React.Component<Props> {
    ...
    @observable
    popoverChildRef: ElementRef<any>;
    @observable
    popoverWidth: number;
    @observable
    ...
    @computed
    get dimensions(): PopoverDimensions {
        const {
            anchorElement,
            verticalOffset,
    ...
    @action setPopoverChildRef = (ref: ElementRef<any>) => {
        if (ref) {
