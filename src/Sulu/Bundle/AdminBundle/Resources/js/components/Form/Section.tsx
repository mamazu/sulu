...
type Props = {
    children: ChildrenArray<Element<typeof Field | typeof Section> | null | undefined> | null | undefined,
    colSpan: ColSpan,
    label?: string
};
    ...
    render() {
        ...
        return (
            <Grid.Section className={gridStyles.gridSection} colSpan={colSpan}>
                {(fields as ChildrenArray<Element<typeof Grid.Item | typeof Grid.Section>>)}
            </Grid.Section>
        );
    }
}
