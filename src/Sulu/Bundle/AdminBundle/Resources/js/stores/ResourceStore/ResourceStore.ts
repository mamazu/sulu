...
export default class ResourceStore {
    ...
    loadOptions: any = {};
    idQueryParameter: string | null | undefined;
    ...
    @action change(path: string, value: unknown) {
        this.set(path, value);
        this.dirty = true;
    }

    @action changeMultiple(data: any) {
    ...
    @action handleIdQueryParameterResponse(response: any) {
        if (response.id) {
