...
class UserStore {
    @observable
    persistentSettings: Map<string, string> = new Map();
    dirtyPersistentSettings: Array<string> = [];

    @observable
    user: User | null | undefined = undefined;
    @observable
    contact: Contact | null | undefined = undefined;
    ...
    updatePersistentSettings = debounce(() => {
        const persistentSettings = this.dirtyPersistentSettings.reduce<Record<string, any>>((persistentSettings, persistentSettingKey) => {
    ...
    @action setPersistentSetting(key: string, value: any) {
    ...
    getPersistentSetting(key: string): any {
