...
function addValueToSearchParameters(searchParameters: URLSearchParams, value: any, path: string) {
...
function addArrayToSearchParameters(searchParameters: URLSearchParams, values: Array<any>, path: string) {
...
function addObjectToSearchParameters(searchParameters: URLSearchParams, value: any, path: string) {
...
function addAttributesFromSearchParameters(attributes: any, value: string, key: string) {
...
export default class Router {
    ...
    updateRouteHooks: {
        [priority: number]: Array<UpdateRouteHook>
    } = {};
    ...
    constructor(history: any) {
        ...
        autorun(() => {
            ...
            if (currentUrl !== historyUrl) {
                ...
                const newLocation = {search: '', ...parsePath(url)} as const;
    ...
    @computed get sortedUpdateRouteHooks() {
        return Object.keys(this.updateRouteHooks)
            ...
            .reduce<Array<any>>((sortedUpdateRouteHooks, priority) => {
                sortedUpdateRouteHooks = [
                    ...sortedUpdateRouteHooks,
                    ...this.updateRouteHooks[(priority as number)],
                ];
    ...
    @action bind(
        ...
        defaultValue: string | null | undefined | number | boolean | any = undefined
    ) {
    ...
    handleNavigation(name: string, attributes: any, updateRouteMethod: UpdateRouteMethod): void {
    ...
    @action navigate = (name: string, attributes: any = {}): void => {
        this.handleNavigation(name, attributes, this.navigate);
    };

    @action navigateToResourceView = (view: string, resourceKey: string, attributes: any = {}): void => {
    ...
    @action redirect = (name: string, attributes: any = {}): void => {
        this.redirectFlag = true;
        this.handleNavigation(name, attributes, this.redirect);
    };

    restore = (name: string, attributes: any = {}): void => {
    ...
    @action
    update(name: string, attributes: any, updateRouteMethod: UpdateRouteMethod): void {
        const route = routeRegistry.get(name);

        const updatedAttributes = {
            ...this.updateAttributesHooks.reduce<Record<string, any>>((hookAttributes: any, updateAttributeHook) => ({
    ...
    isRouteChanging(name: string, attributes: any) {
        const route = routeRegistry.get(name);
