...
function transformParameters(parameters) {
    return Object.keys(parameters)
        ...
        .reduce<Record<string, any>>((transformedParameters, parameterKey) => {
...
class ResourceRouteRegistry {
    ...
    // @deprecated
    getDetailUrl(resourceKey: string, parameters: any = {}) {
        log.warn(
    ...
    // @deprecated
    getListUrl(resourceKey: string, parameters: any = {}) {
        log.warn(
    ...
    getUrl(type: string, resourceKey: string, parameters: any = {}) {
