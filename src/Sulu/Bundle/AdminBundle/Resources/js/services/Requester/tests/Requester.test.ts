...
test('Should execute GET request and reject with response when the response contains error', () => {
    ...
    const promise = new Promise((resolve: any) => resolve(response));
...
test('Should execute GET request and replace null with undefined', () => {
    ...
    const requestPromise = Requester.get('/some-url').then((data: any) => {
        expect(data).toEqual({
            test1: undefined,
            test2: undefined,
            test3: '',
...
test('Should execute POST request and return JSON', () => {
    ...
    const requestPromise = Requester.post('/some-url', data).then((response: any) => {
...
test('Should execute PUT request and return JSON', () => {
    ...
    const requestPromise = Requester.put('/some-url', data).then((response: any) => {
        expect(response).toEqual({test: '', value: 'test'});
    });
...
test('Should execute PUT request without data and return JSON', () => {
    ...
    const requestPromise = Requester.put('/some-url', null).then((response: any) => {
        expect(response).toEqual({test: '', value: 'test'});
    });
...
test('Should execute PATCH request and return JSON', () => {
    ...
    const requestPromise = Requester.patch('/some-url', data).then((response: any) => {
        expect(response).toEqual([{test: '', value: 'test'}]);
    });
...
test('Should execute DELETE request and return JSON', () => {
    ...
    const requestPromise = Requester.delete('/some-url').then((data: any) => {
...
test('Should execute DELETE request and return empty object if status code was 204', () => {
    ...
    return Requester.delete('/some-url').then((data: any) => {
        expect(data).toEqual({});
    });
});
