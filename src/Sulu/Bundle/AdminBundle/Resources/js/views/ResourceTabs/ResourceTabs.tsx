...
class ResourceTabs extends React.Component<Props> {
    ...
    disposeCreateResourceStoreOnRouteChange = (route?: Route | null) => {
    ...
    reloadResourceStoreOnRouteChange = (route?: Route | null, attributes?: AttributeMap | null) => {
    ...
    @computed
    get visibleTabRoutes(): Array<any> {
