...
class FormOverlayList extends React.Component<Props> {
    ...
    listRef: ElementRef<typeof List> | null | undefined;

    @observable
    formStore: ResourceFormStore | null | undefined;
    ...
    @action createFormOverlay = (itemId: string | null | undefined | number) => {
        const {
            router: {
                attributes,
                route: {
    ...
    buildFormStoreOptions(
        ...
        attributes: any,
        routerAttributesToFormRequest: Partial<Record<string | number, string>>,
        resourceStorePropertiesToFormRequest: Partial<Record<string | number, string>>
    ) {
    ...
    buildFormStoreMetadataOptions(
        metadataRequestParameters: any,
        attributes: any,
        routerAttributesToFormMetadata: Partial<Record<string | number, string>>
    ) {
    ...
    setListRef = (listRef?: ElementRef<typeof List> | null) => {
