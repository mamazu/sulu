...
jest.mock('../../List', () => (class ListMock extends mockReact.Component<any> {
    render() {
        return <div>list view mock</div>;
    }
}));

jest.mock('../../../containers/Form/Form', () => (class FormMock extends mockReact.Component<any> {
    render() {
...
jest.mock('../../../containers/Form/stores/ResourceFormStore', () => jest.fn(
    (resourceStore: any, formKey: any, options: any, metadataOptions: any) => {
        return {
            id: resourceStore.id,
            metadataOptions,
        };
