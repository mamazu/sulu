...
jest.mock('debounce', () => jest.fn((callback: any) => callback));
...
test('Should mark currently active tab as selected according to prop', (done: any) => {
    const childRoute1 = new Route({
        name: 'route1',
        options: {
            tabTitle: 'tabTitle1',
...
test('Should mark currently active tab as selected', (done: any) => {
    const childRoute1 = new Route({
        name: 'route1',
        options: {
            tabTitle: 'tabTitle1',
...
test('Should redirect to child route with highest priority if no tab is active by default', (done: any) => {
    const childRoute1 = new Route({
        name: 'route1',
        options: {
            tabTitle: 'tabTitle1',
...
test('Should redirect to child route from props with highest priority if no tab is active by default', (done: any) => {
    const childRoute1 = new Route({
        name: 'route1',
        options: {
            tabTitle: 'tabTitle1',
