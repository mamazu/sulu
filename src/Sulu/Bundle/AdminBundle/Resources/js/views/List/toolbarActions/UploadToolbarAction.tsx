...
export default class UploadToolbarAction extends AbstractListToolbarAction {
    @observable
    dropzoneRef: ElementRef<typeof Dropzone> | null | undefined;
    @observable
    errors: string[] = [];
    ...
    @action setDropzoneRef = (ref?: ElementRef<typeof Dropzone> | null) => {
    ...
    @computed
    get errorCodeMapping(): Readonly<any> {
    ...
    @computed
    get requestParameters(): Readonly<any> {
        const {
            options: {
    ...
    get accept(): {
        ...
        const dropzoneObjectOption: Record<string, any> = {};
        accept.forEach((type) => {
    ...
    @computed
    get minSize(): number | null | undefined {
    ...
    @computed
    get maxSize(): number | null | undefined {
    ...
    @computed
    get maxFiles(): number | null | undefined {
        return this.multiple ? undefined : 1;
    }

    @computed
    get requestPropertyName(): string {
