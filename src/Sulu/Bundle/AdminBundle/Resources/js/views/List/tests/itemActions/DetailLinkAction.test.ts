...
test('Return correct icon action config for given item', () => {
    ...
    (linkItemAction.router.hasResourceView as any).mockReturnValue(true);
...
test('Return disabled icon action config if link_property of given icon is not set', () => {
    ...
    (linkItemAction.router.hasResourceView as any).mockReturnValue(false);
...
test('Throw error if "resource_key_property" item is not correctly set', () => {
    ...
    const item = {resourceKey: {}} as const;
...
test('Throw error if "resource_key_property" item is not correctly set', () => {
    ...
    const item = {resourceId: {}} as const;
...
test('Throw error if "resource_key_property" item is not correctly set', () => {
    ...
    const item = {resourceViewAttributes: 'false'} as const;
