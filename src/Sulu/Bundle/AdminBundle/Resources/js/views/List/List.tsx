...
type Props = ViewProps & {
    ...
    onItemAdd?: (parentId: string | null | undefined | number) => void,
...
class List extends React.Component<Props> {
    ...
    locale: IObservableValue<string>;
    listStore: ListStore;
    list: ElementRef<typeof ListContainer> | null | undefined;

    @observable
    toolbarActions: Array<AbstractListToolbarAction> = [];
    @observable
    itemActions: Array<AbstractListItemAction> = [];
    @observable errors = [];
    ...
    buildMetadataOptions(
        attributes: any,
        routerAttributesToListMetadata: Partial<Record<string | number, string>>,
        resourceStorePropertiesToListMetadata: Partial<Record<string | number, string>>,
        resourceStore: ResourceStore | null | undefined,
        metadataRequestParameters: Partial<Record<string | number, string>>
    ) {
        const metadataOptions = {...metadataRequestParameters} as const;
    ...
    buildListStoreOptions(
        ...
        attributes: any,
        routerAttributesToListRequest: Partial<Record<string | number, string>>,
        resourceStorePropertiesToListRequest: Partial<Record<string | number, string>>,
    ...
    addItem = (parentId: string | null | undefined | number) => {
    ...
    getItemActionConfigs = (item?: any | null): Array<ItemActionConfig> => {
    ...
    setListRef = (list?: ElementRef<typeof ListContainer> | null) => {
        this.list = list;
    };

    @action handleDeleteError = (error?: any): void => {
