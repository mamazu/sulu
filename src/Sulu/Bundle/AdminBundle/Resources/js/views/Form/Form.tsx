...
class Form extends React.Component<Props> {
    ...
    collaborationStore: CollaborationStore | null | undefined;
    form: ElementRef<typeof FormContainer> | null | undefined;
    @observable
    errors: Array<string> = [];
    ...
    @observable
    showDirtyWarning: boolean = false;
    @observable
    showHasChangedWarning: boolean = false;
    postponedSaveOptions: any;
    postponedUpdateRouteMethod: UpdateRouteMethod | null | undefined;
    postponedRoute: Route | null | undefined;
    postponedRouteAttributes: AttributeMap | null | undefined;
    ...
    @action checkFormStoreDirtyStateBeforeNavigation = (
        ...
        updateRouteMethod?: UpdateRouteMethod | null
    ) => {
    ...
    @action submit = (options: string | null | undefined | {
        [key: string]: any
    }) => {
    ...
    handleSubmit = (options: string | null | undefined | {
        [key: string]: any
    }) => {
        if (typeof options === 'string') {
            log.warn(
    ...
    save = (options: any) => {
        ...
        const saveOptions = {...options} as const;

        const editViewParameters: Record<string, any> = {};
    ...
    navigateBack = () => {
        ...
        const backViewParameters: Record<string, any> = {};
    ...
    setFormRef = (form?: ElementRef<typeof FormContainer> | null) => {
        this.form = form;
    };
