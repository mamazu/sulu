...
function createDropdownToolbarAction(options = {}) {
    ...
    return new DropdownToolbarAction_1.default(resourceFormStore, form, router, [], options, resourceStore);
}
test('Return item config with an option for every action in array and skip undefined button', () => {
    ...
    formToolbarActionRegistry_1.default.get.mockImplementation((key) => {
        switch (key) {
...
test('Return JSX for all child ToolbarActions', () => {
    ...
    expect((0, enzyme_1.render)(dropdownToolbarAction.getNode())).toMatchSnapshot();
});
