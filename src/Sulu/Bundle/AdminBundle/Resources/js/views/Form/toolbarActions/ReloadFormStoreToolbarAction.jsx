...
let ReloadFormStoreToolbarAction = (() => {
    var _a;
    ...
    return _a = class ReloadFormStoreToolbarAction extends _classSuper {
            constructor(resourceFormStore, form, router, locales, options, parentResourceStore) {
                ...
                this.handleClick = (__runInitializers(this, _showDialog_extraInitializers), __runInitializers(this, _handleClick_initializers, () => __awaiter(this, void 0, void 0, function* () {
                    this.openDialog();
                })));
                this.handleOnConfirm = (__runInitializers(this, _handleClick_extraInitializers), () => {
                    this.fetchData();
                });
                this.fetchData = __runInitializers(this, _fetchData_initializers, () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    services_1.Requester.post(url).then((0, mobx_1.action)(() => {
                ...
                this.handleDialogClose = (__runInitializers(this, _setError_extraInitializers), () => {
                    this.closeDialog();
                });
            ...
            getNode() {
                return (<Dialog_1.default cancelText={this.dialogCancelText || (0, utils_1.translate)('sulu_admin.cancel')} confirmLoading={this.loading} confirmText={this.dialogOkText || (0, utils_1.translate)('sulu_admin.ok')} key={this.dialogKey} onCancel={this.handleDialogClose} onConfirm={this.handleOnConfirm} open={this.showDialog} title={this.dialogTitle}>
...
exports.default = ReloadFormStoreToolbarAction;
