...
function createCopyLocaleToolbarAction(locales: any, options = {}) {
...
test('Close dialog and show success message when onClose from CopyLocaleDialog is called with true', (resolve: any) => {
...
test('Close dialog and show success message when onClose from CopyLocaleDialog is called with true (with additional fields)', (resolve: any) => { // eslint-disable-line max-len
    const formMetadata = {
        ...FORM,
        title: {
            label: 'Test',
