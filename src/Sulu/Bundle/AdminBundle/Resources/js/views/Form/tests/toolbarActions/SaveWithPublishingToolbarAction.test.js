...
function createSaveWithPublishingToolbarAction(options = {}) {
    ...
    return new SaveWithPublishingToolbarAction_1.default(resourceFormStore, form, router, [], options, resourceStore);
}
...
test('Return item config without publish specific options if deprecated publish_display_condition is not met', () => {
    ...
    expect(loglevel_1.default.warn).toBeCalledWith(expect.stringContaining('The "publish_display_condition" option is deprecated'));
});
test('Return item config without publish specific options if passed publish_visible_condition is not met', () => {
    ...
    expect(loglevel_1.default.warn).not.toBeCalledWith(expect.stringContaining('The "publish_display_condition" option is deprecated'));
});
test('Return item config without saving specific options if deprecated save_display_condition is not met', () => {
    ...
    expect(loglevel_1.default.warn).toBeCalledWith(expect.stringContaining('The "save_display_condition" option is deprecated'));
});
test('Return item config without saving specific options if passed save_visible_condition is not met', () => {
    ...
    expect(loglevel_1.default.warn).not.toBeCalledWith(expect.stringContaining('The "save_display_condition" option is deprecated'));
});
