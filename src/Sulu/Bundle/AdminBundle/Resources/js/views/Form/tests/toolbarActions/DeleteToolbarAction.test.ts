...
jest.mock('../../../../stores/ResourceStore', () => jest.fn(function(resourceKey: any, id: any, observableOptions: any) {
    this.id = id;
...
jexl.addTransform('length', (value: Array<any>) => value.length);
...
test('Call delete with force when dialog is confirmed twice', (done: any) => {
    const deleteToolbarAction = createDeleteToolbarAction();
    deleteToolbarAction.resourceFormStore.resourceStore.id = 3;
    deleteToolbarAction.router.route.options.backView = 'sulu_test.list';
...
test('Call delete with force and deleteLocale when dialog is confirmed twice', (done: any) => {
    const deleteToolbarAction = createDeleteToolbarAction({delete_locale: true});
    deleteToolbarAction.resourceFormStore.resourceStore.id = 3;
    deleteToolbarAction.router.route.options.backView = 'sulu_test.list';
...
test('Cancel delete conflict occured with the allowConflictDeletion option set to false', (done: any) => {
...
test('Call delete when DeleteDependantResourcesDialog is finished', (done: any) => {
    const deleteToolbarAction = createDeleteToolbarAction();
    deleteToolbarAction.resourceFormStore.resourceStore.id = 3;
    deleteToolbarAction.router.route.options.backView = 'sulu_test.list';
...
test('Do not call delete when DeleteDependantResourcesDialog is cancelled', (done: any) => {
    const deleteToolbarAction = createDeleteToolbarAction();
    deleteToolbarAction.resourceFormStore.resourceStore.id = 3;
    deleteToolbarAction.router.route.options.backView = 'sulu_test.list';
