...
export default class DropdownToolbarAction extends AbstractFormToolbarAction {
    ...
    getToolbarItemConfig(): DropdownItemConfig | null | undefined {
        ...
        const childToolbarItemConfigs: Array<ToolbarItemConfig<any>> = this.toolbarActions
