...
const FormInspector_1 = __importDefault(require("../../Form/FormInspector"));
const metadataStore_1 = __importDefault(require("../../Form/stores/metadataStore"));
...
const fieldRegistry_1 = __importDefault(require("../../Form/registries/fieldRegistry"));
const SingleSelect_1 = __importDefault(require("../../Form/fields/SingleSelect"));
...
beforeEach(() => {
    blockPreviewTransformerRegistry_1.default.has.mockClear();
    blockPreviewTransformerRegistry_1.default.get.mockClear();
    blockPreviewTransformerRegistry_1.default.blockPreviewTransformerKeysByPriority = [];
});
test('Render collapsed blocks with block previews', () => {
    ...
    blockPreviewTransformerRegistry_1.default.has.mockImplementation((key) => {
        switch (key) {
            case 'text_line':
                return true;
            default:
    ...
    blockPreviewTransformerRegistry_1.default.get.mockImplementation((key) => {
        switch (key) {
            case 'text_line':
                return {
    ...
    const fieldBlocks = (0, enzyme_1.mount)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} defaultType="editor" formInspector={formInspector} schemaOptions={{ settings_form_key: { name: 'settings_form_key', value: 'page_block_settings' } }} types={types} value={value}/>);
...
test('Render collapsed blocks with block previews and sections', () => {
    ...
    const fieldBlocks = (0, enzyme_1.shallow)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} defaultType="editor" formInspector={formInspector} types={types} value={value}/>);
    expect(fieldBlocks.render()).toMatchSnapshot();
});
test('Render collapsed blocks with block previews without tags and with sections', () => {
    ...
    const fieldBlocks = (0, enzyme_1.shallow)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} defaultType="default" formInspector={formInspector} types={types} value={value}/>);
    expect(fieldBlocks.render()).toMatchSnapshot();
});
...
test('Render block with schema', () => {
    ...
    const fieldBlocks = (0, enzyme_1.mount)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} defaultType="editor" formInspector={formInspector} types={types} value={value}/>);
...
test('Call not onChange on componentDidUpdate when new types are the same', () => {
    ...
    const fieldBlocks = (0, enzyme_1.shallow)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} defaultType="default" formInspector={formInspector} onChange={changeSpy} types={{
            default: {
                title: 'Default',
                form: {
                    text1: {
...
test('Call onChange on componentDidUpdate when type not longer exist', () => {
    ...
    const fieldBlocks = (0, enzyme_1.mount)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} defaultType="default" formInspector={formInspector} onChange={changeSpy} types={{
            default: {
                title: 'Default',
                form: {
                    text1: {
...
test('Render block with schema and error on fields already being modified', () => {
    ...
    const fieldBlocks = (0, enzyme_1.mount)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} dataPath="/block" defaultType="editor" error={error} formInspector={formInspector} schemaPath="/block" types={types} value={value}/>);
    fieldBlocks.find('Block').at(0).simulate('click');
    fieldBlocks.find('Block').at(1).simulate('click');
...
test('Render block with schema and error on fields already being modified', () => {
    ...
    const fieldBlocks = (0, enzyme_1.mount)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} defaultType="editor" error={error} formInspector={formInspector} showAllErrors={true} types={types} value={value}/>);
    fieldBlocks.find('Block').at(0).simulate('click');
    fieldBlocks.find('Block').at(1).simulate('click');
    fieldBlocks.find('Block').at(2).simulate('click');
...
test('Should correctly pass props to the BlockCollection', () => {
    ...
    const value = [];
    const fieldBlocks = (0, enzyme_1.shallow)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} defaultType="editor" disabled={true} formInspector={formInspector} label="Test" maxOccurs={2} minOccurs={1} schemaOptions={{
...
test('Should pass collapsable and movable props to the BlockCollection', () => {
    ...
    const fieldBlocks = (0, enzyme_1.shallow)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} defaultType="editor" disabled={true} formInspector={formInspector} label="Test" maxOccurs={2} minOccurs={1} schemaOptions={{ movable: { name: 'movable', value: false }, collapsable: { name: 'collapsable', value: false } }} types={types} value={[]}/>);
    expect(fieldBlocks.find('BlockCollection').props()).toEqual(expect.objectContaining({
        collapsable: false,
        movable: false,
    }));
...
test('Should pass new value to the BlockCollection if value prop is updated', () => {
    ...
    const fieldBlocks = (0, enzyme_1.shallow)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} defaultType="editor" disabled={true} formInspector={formInspector} label="Test" maxOccurs={2} minOccurs={1} types={types} value={[]}/>);
    ...
    fieldBlocks.setProps({ value: (0, mobx_1.observable)([{ type: 'default', text: 'Two' }]) });
    expect(fieldBlocks.find('BlockCollection').props().value).toEqual([{ type: 'default', text: 'Two' }]);
    fieldBlocks.setProps({ value: (0, mobx_1.observable)([{ type: 'default', text: 'Three' }]) });
...
test('Should pass correct data and value and router to FieldRenderer', () => {
    ...
    const fieldBlocks = (0, enzyme_1.mount)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} data={data} dataPath="" defaultType="editor" formInspector={formInspector} router={router} schemaPath="" types={types} value={value}/>);
...
test('Should pass correct schemaPath and router to FieldRenderer', () => {
    ...
    formInspector.getSchemaEntryByPath.mockReturnValue({ types });
    const fieldBlocks = (0, enzyme_1.mount)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} dataPath="" defaultType="editor" formInspector={formInspector} router={router} schemaPath="" types={types} value={[{ type: 'default' }, { type: 'default' }]}/>);
    fieldBlocks.find('SortableBlockList').prop('onExpand')(0);
    fieldBlocks.find('SortableBlockList').prop('onExpand')(1);
    fieldBlocks.update();
...
test('Should call onFinish when a field from the child renderer has finished editing', () => {
    ...
    const fieldBlocks = (0, enzyme_1.mount)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} dataPath="" defaultType="editor" fieldTypeOptions={{}} formInspector={formInspector} onFinish={finishSpy} schemaPath="" types={types} value={value}/>);
...
test('Should set nested properties in handleBlockChange and call onChange with new values', () => {
    ...
    formInspector.getSchemaEntryByPath.mockReturnValue({ types });
    const changeSpy = jest.fn();
    const fieldBlocks = (0, enzyme_1.mount)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} dataPath="" defaultType="editor" fieldTypeOptions={{}} formInspector={formInspector} onChange={changeSpy} schemaPath="" types={types} value={value}/>);
    fieldBlocks.find('Block').simulate('click');
...
test('Should call onFinish when the order of the blocks has changed', () => {
    ...
    formInspector.getSchemaEntryByPath.mockReturnValue({ types });
    const finishSpy = jest.fn();
    const fieldBlocks = (0, enzyme_1.shallow)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} defaultType="editor" formInspector={formInspector} onFinish={finishSpy} types={types} value={value}/>);
...
test('Should open and close block settings overlay when confirm button is clicked with changed data', () => {
    ...
    metadataStore_1.default.getSchema.mockReturnValue(schemaPromise);
    metadataStore_1.default.getJsonSchema.mockReturnValue(jsonSchemaPromise);
    const fieldBlocks = (0, enzyme_1.mount)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} defaultType="editor" formInspector={formInspector} onChange={changeSpy} schemaOptions={{ settings_form_key: { name: 'settings_form_key', value: 'page_block_settings' } }} types={types} value={value}/>);
    expect(metadataStore_1.default.getSchema).toBeCalledWith('page_block_settings', undefined, undefined);
    expect(metadataStore_1.default.getJsonSchema).toBeCalledWith('page_block_settings', undefined, undefined);
    expect(fieldBlocks.exists('FormOverlay')).toEqual(false);
    fieldBlocks.find('Block').at(1).simulate('click');
    ...
    return Promise.all([schemaPromise, jsonSchemaPromise]).then(() => {
        ...
        expect(fieldBlocks.exists('FormOverlay')).toEqual(false);
        expect(changeSpy).toBeCalledWith([{ type: 'default', settings: { setting: false } }, { type: 'default', settings: { setting: true } }]);
...
test('Should display correct icons based on visibleCondition', () => {
    const formInspector = new FormInspector_1.default(new ResourceFormStore_1.default(new ResourceStore_1.default('test'), 'test'));
    conditionDataProviderRegistry_1.default.add(() => ({ __locale: 'de' }));
    const types = {
        default: {
            title: 'Default',
            form: {
...
test('Should recalculate visibleCondition only of changed blocks', () => {
    ...
    return Promise.all([schemaPromise, jsonSchemaPromise]).then(() => {
        ...
        conditionDataProviderRegistry_1.default.add(() => ({
            __provider: {
                'text1': 'disabled',
            },
        }));
...
test('Should destroy the block settings form-store on unmount', () => {
    ...
    const formInspector = new FormInspector_1.default(new ResourceFormStore_1.default(new ResourceStore_1.default('test'), 'test'));
    const fieldBlocks = (0, enzyme_1.mount)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} defaultType="editor" formInspector={formInspector} schemaOptions={{ settings_form_key: { name: 'settings_form_key', value: 'page_block_settings' } }} types={types}/>);
...
test('Should set correct default values for multiple single_select in blocks', () => {
    ...
    const changeSpy = jest.fn();
    const fieldBlocks = (0, enzyme_1.mount)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} defaultType="default" formInspector={formInspector} minOccurs={1} onChange={changeSpy} types={types} value={(0, mobx_1.observable)([{ type: 'default' }])}/>);
    fieldBlocks.find('Block').at(0).simulate('click');
    expect(changeSpy).toBeCalledWith([
        {
            'position_left': 'left',
...
test('Throw error if no default type are passed', () => {
    const formInspector = new FormInspector_1.default(new ResourceFormStore_1.default(new ResourceStore_1.default('test'), 'test'));
    expect(() => (0, enzyme_1.shallow)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} formInspector={formInspector}/>)).toThrow('The "block" field type needs a defaultType!');
});
test('Throw error if no types are passed', () => {
    const formInspector = new FormInspector_1.default(new ResourceFormStore_1.default(new ResourceStore_1.default('test'), 'test'));
    expect(() => (0, enzyme_1.shallow)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} defaultType="editor" formInspector={formInspector}/>)).toThrow('The "block" field type needs at least one type to be configured!');
});
test('Throw error if empty type array is passed', () => {
    const formInspector = new FormInspector_1.default(new ResourceFormStore_1.default(new ResourceStore_1.default('test'), 'test'));
    expect(() => (0, enzyme_1.shallow)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} defaultType="editor" formInspector={formInspector} value={[]}/>)).toThrow('The "block" field type needs at least one type to be configured!');
});
test('Throw error if passed settings_form_key schema option is not a string', () => {
    ...
    expect(() => (0, enzyme_1.shallow)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} defaultType="editor" formInspector={formInspector} schemaOptions={{ settings_form_key: { name: 'settings_form_key', value: [] } }} types={types} value={[]}/>)).toThrow('The "block" field types only accepts strings as "settings_form_key" schema option!');
});
test('Throw error if passed add_button_text schema option is not a string', () => {
    ...
    expect(() => (0, enzyme_1.shallow)(<FieldBlocks_1.default {...fieldTypeDefaultProps_1.default} defaultType="editor" formInspector={formInspector} schemaOptions={{ add_button_text: { name: 'add_button_text', title: [] } }} types={types} value={[]}/>)).toThrow('The "block" field types only accepts strings as "add_button_text" schema option!');
});
