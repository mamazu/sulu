...
export default class AiApplication extends Component<Props> {
    ...
    @observable
    writingAssistantOpen: boolean = false;
    @observable
    translateOpen: boolean = false;
    @observable
    hasFocus: boolean = false;
    @observable
    writingAssistantIdentifier: number | null | undefined = undefined;
    @observable
    translateIdentifier: number | null | undefined = undefined;
