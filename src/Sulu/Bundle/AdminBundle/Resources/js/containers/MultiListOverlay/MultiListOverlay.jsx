...
let MultiListOverlay = (() => {
    let _classDecorators = [mobx_react_1.observer];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = react_1.default.Component;
    var MultiListOverlay = _classThis = class extends _classSuper {
        constructor(props) {
            super(props);
            ...
            this.listStore = new ListStore_1.default(resourceKey, listKey, USER_SETTINGS_KEY, observableOptions, options, undefined, preloadSelectedItems ? preSelectedItems.map((preSelectedItem) => preSelectedItem.id) : undefined);
        ...
        render() {
            const { adapter, allowActivateForDisabledItems, clearSelectionOnClose, confirmLoading, disabledIds, itemDisabledCondition, onClose, open, overlayType, preSelectedItems, reloadOnOpen, title, } = this.props;
            return (<ListOverlay_1.default adapter={adapter} allowActivateForDisabledItems={allowActivateForDisabledItems} clearSelectionOnClose={clearSelectionOnClose} confirmLoading={confirmLoading} disabledIds={disabledIds} itemDisabledCondition={itemDisabledCondition} listStore={this.listStore} onClose={onClose} onConfirm={this.handleConfirm} open={open} overlayType={overlayType} preSelectedItems={preSelectedItems} reloadOnOpen={reloadOnOpen} title={title}/>);
        }
    };
    __setFunctionName(_classThis, "MultiListOverlay");
    (() => {
        var _a;
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        MultiListOverlay = _classThis = _classDescriptor.value;
    ...
    return MultiListOverlay = _classThis;
})();
exports.default = MultiListOverlay;
