...
test('Pass correct sections prop', () => {
    ...
    const smartContent = (0, enzyme_1.shallow)(<SmartContent_1.default defaultValue={defaultValue} fieldLabel="Test" store={smartContentStore}/>);
...
test('Pass correct props to MultiItemSelection component', () => {
    ...
    const smartContentStore = new SmartContentStore_1.default('content');
    const smartContent = (0, enzyme_1.shallow)(<SmartContent_1.default defaultValue={defaultValue} disabled={true} fieldLabel="Test" store={smartContentStore}/>);
...
test('Pass correct sections prop with other values', () => {
    ...
    const smartContentStore = new SmartContentStore_1.default('content');
    const smartContent = (0, enzyme_1.shallow)(<SmartContent_1.default categoryRootKey="test1" defaultValue={defaultValue} fieldLabel="Test" presentations={presentations} store={smartContentStore}/>);
...
test('Open and closes the FilterOverlay when the icon is clicked', () => {
    ...
    expect(Translator_1.translate).toBeCalledWith('sulu_admin.filter_overlay_title', { fieldLabel: 'Test' });
});
...
test('Call onItemClick when an item in the SmartContent is clicked', () => {
    ...
    const smartContent = (0, enzyme_1.mount)(<SmartContent_1.default defaultValue={defaultValue} fieldLabel="Test" onItemClick={itemClickSpy} store={smartContentStore}/>);
