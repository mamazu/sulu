...
type Props = {
    categoryRootKey: string | null | undefined,
    dataSourceAdapter: string | null | undefined,
    dataSourceListKey: string | null | undefined,
...
class FilterOverlay extends React.Component<Props> {
    ...
    @action handleConfirmDataSourceDialog = (dataSource: any) => {
    ...
    @action handleConfirmCategoryDialog = (categories: Array<any>) => {
    ...
    @action handleLimitChange = (limit?: number | null) => {
        this.limit = limit;
    };
