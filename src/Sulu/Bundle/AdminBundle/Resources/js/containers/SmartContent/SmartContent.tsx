...
type Props = {
    ...
    onItemClick?: (id: number | string, item?: any | null | undefined) => void,
...
class SmartContent extends React.Component<Props> {
    ...
    render() {
        ...
        const presentations = this.props.presentations.reduce<Record<string, any>>((presentations, presentation) => {
