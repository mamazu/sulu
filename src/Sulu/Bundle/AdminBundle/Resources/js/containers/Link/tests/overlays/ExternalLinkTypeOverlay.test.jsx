...
test('Render overlay with an undefined URL', () => {
    const externalLinkOverlay = (0, enzyme_1.mount)(<ExternalLinkTypeOverlay_1.default href={undefined} onCancel={jest.fn()} onConfirm={jest.fn()} onHrefChange={jest.fn()} onRelChange={jest.fn()} onTargetChange={jest.fn()} onTitleChange={jest.fn()} open={true} rel={undefined} target={undefined} title={undefined}/>);
    expect(externalLinkOverlay.find('Form').render()).toMatchSnapshot();
});
test('Render overlay with mailto URL', () => {
    const externalLinkOverlay = (0, enzyme_1.mount)(<ExternalLinkTypeOverlay_1.default href="mailto:test@example.org?subject=Subject&body=Body" onCancel={jest.fn()} onConfirm={jest.fn()} onHrefChange={jest.fn()} onRelChange={jest.fn()} onTargetChange={jest.fn()} onTitleChange={jest.fn()} open={true} rel={undefined} target={undefined} title={undefined}/>);
    expect(externalLinkOverlay.find('Form').render()).toMatchSnapshot();
});
test('Render overlay with a URL', () => {
    const externalLinkOverlay = (0, enzyme_1.mount)(<ExternalLinkTypeOverlay_1.default href="http://www.sulu.io" onCancel={jest.fn()} onConfirm={jest.fn()} onHrefChange={jest.fn()} onRelChange={jest.fn()} onTargetChange={jest.fn()} onTitleChange={jest.fn()} open={true} rel={undefined} target={undefined} title={undefined}/>);
    expect(externalLinkOverlay.find('Form').render()).toMatchSnapshot();
});
test('Pass correct props to Dialog', () => {
    const cancelSpy = jest.fn();
    const confirmSpy = jest.fn();
    const externalLinkOverlay = (0, enzyme_1.shallow)(<ExternalLinkTypeOverlay_1.default href={undefined} onCancel={cancelSpy} onConfirm={confirmSpy} onHrefChange={jest.fn()} onRelChange={jest.fn()} onTargetChange={jest.fn()} onTitleChange={jest.fn()} open={false} rel={undefined} target={undefined} title={undefined}/>);
...
test('Display given URL with query parameters in href input', () => {
    ...
    const externalLinkOverlay = (0, enzyme_1.shallow)(<ExternalLinkTypeOverlay_1.default href="http://www.sulu.io/contact-us?param=value-1" onCancel={jest.fn()} onConfirm={jest.fn()} onHrefChange={urlChangeSpy} onTargetChange={targetChangeSpy} onTitleChange={jest.fn()} open={true} target="_blank" title={undefined}/>);
...
test('Do not call onHrefChange handler if input did not loose focus', () => {
    const targetChangeSpy = jest.fn();
    const urlChangeSpy = jest.fn();
    const externalLinkOverlay = (0, enzyme_1.shallow)(<ExternalLinkTypeOverlay_1.default href={undefined} onCancel={jest.fn()} onConfirm={jest.fn()} onHrefChange={urlChangeSpy} onRelChange={jest.fn()} onTargetChange={targetChangeSpy} onTitleChange={jest.fn()} open={true} rel={undefined} target="_blank" title={undefined}/>);
...
test('Fields should change immediately after protocol was changed', () => {
    const targetChangeSpy = jest.fn();
    const urlChangeSpy = jest.fn();
    const externalLinkOverlay = (0, enzyme_1.mount)(<ExternalLinkTypeOverlay_1.default href={undefined} onCancel={jest.fn()} onConfirm={jest.fn()} onHrefChange={urlChangeSpy} onRelChange={jest.fn()} onTargetChange={targetChangeSpy} onTitleChange={jest.fn()} open={true} rel={undefined} target="_blank" title={undefined}/>);
...
test('Call onHrefChange with URL that includes mail subject and mail body for mailto links', () => {
    const targetChangeSpy = jest.fn();
    const urlChangeSpy = jest.fn();
    const externalLinkOverlay = (0, enzyme_1.shallow)(<ExternalLinkTypeOverlay_1.default href="mailto:bla@example.org" onCancel={jest.fn()} onConfirm={jest.fn()} onHrefChange={urlChangeSpy} onRelChange={jest.fn()} onTargetChange={targetChangeSpy} onTitleChange={jest.fn()} open={true} rel={undefined} target="_blank" title={undefined}/>);
...
test('Should not include mail subject and body in URL after switching to another protocol', () => {
    const urlChangeSpy = jest.fn();
    const externalLinkOverlay = (0, enzyme_1.mount)(<ExternalLinkTypeOverlay_1.default href="mailto:test@example.org?subject=Subject&body=Body%20Text" onCancel={jest.fn()} onConfirm={jest.fn()} onHrefChange={urlChangeSpy} onTargetChange={jest.fn()} onTitleChange={jest.fn()} open={true} target="_blank" title={undefined}/>);
    externalLinkOverlay.find('Url').prop('onBlur')();
...
test('Reset target to self when a mailto link is entered', () => {
    const targetChangeSpy = jest.fn();
    const urlChangeSpy = jest.fn();
    const externalLinkOverlay = (0, enzyme_1.shallow)(<ExternalLinkTypeOverlay_1.default href="http://www.sulu.io" onCancel={jest.fn()} onConfirm={jest.fn()} onHrefChange={urlChangeSpy} onRelChange={jest.fn()} onTargetChange={targetChangeSpy} onTitleChange={jest.fn()} open={true} rel={undefined} target="_blank" title={undefined}/>);
    externalLinkOverlay.find('Url').prop('onChange')('mailto:test@example.org');
    externalLinkOverlay.find('Url').prop('onBlur')();
    expect(urlChangeSpy).toBeCalledWith('mailto:test@example.org');
    expect(targetChangeSpy).toBeCalledWith('_self');
...
test('Rel value should be transformed correctly', () => {
    ...
    const externalLinkOverlay = (0, enzyme_1.mount)(<ExternalLinkTypeOverlay_1.default href={undefined} onCancel={jest.fn()} onConfirm={jest.fn()} onHrefChange={urlChangeSpy} onRelChange={relChangeSpy} onTargetChange={jest.fn()} onTitleChange={jest.fn()} open={true} rel="noopener  noreferrer " target={undefined} title={undefined}/>);
