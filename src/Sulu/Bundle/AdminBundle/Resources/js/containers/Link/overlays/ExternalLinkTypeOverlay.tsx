...
class ExternalLinkTypeOverlay extends React.Component<LinkTypeOverlayProps> {
    @observable
    protocol: string | null | undefined = undefined;
    @observable
    href: string | null | undefined = undefined;
    @observable
    mailSubject: string | null | undefined = undefined;
    @observable
    mailBody: string | null | undefined = undefined;
    ...
    @action handleHrefChange = (href?: string | null) => {
        this.href = href;
    };

    handleMailSubjectBlur = this.callUrlChange;

    @action handleProtocolChange = (protocol?: string | null) => {
        this.protocol = protocol;
    };

    @action handleMailSubjectChange = (mailSubject?: string | null) => {
        this.mailSubject = mailSubject;
    };

    handleMailBodyBlur = this.callUrlChange;

    @action handleMailBodyChange = (mailBody?: string | null) => {
