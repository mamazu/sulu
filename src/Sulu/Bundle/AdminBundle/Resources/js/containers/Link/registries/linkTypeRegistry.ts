...
class linkTypeRegistry {
    overlays: {
        [key: string]: ComponentType<LinkTypeOverlayProps>
    };
    titles: {
        [key: string]: string
    };
    options: {
        [key: string]: LinkTypeOptions | null | undefined
    };
    ...
    getOptions(name: string): LinkTypeOptions | null | undefined {
