...
class Login extends React.Component<Props> {
    ...
    @observable
    visibleForm: FormTypes = this.props.router.attributes.forgotPasswordToken ? 'reset-password' : 'login';

    @computed
    get loginFormVisible(): boolean {
        return this.visibleForm === 'login';
    }

    @computed
    get forgotPasswordFormVisible(): boolean {
        return this.visibleForm === 'forgot-password';
    }

    @computed
    get resetPasswordFormVisible(): boolean {
        return this.visibleForm === 'reset-password';
    }

    @computed
    get twoFactorVisible(): boolean {
