...
let ForgotPasswordForm = (() => {
    ...
    var ForgotPasswordForm = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
            ...
            this.setInputRef = (__runInitializers(this, _user_extraInitializers), __runInitializers(this, _setInputRef_initializers, (ref) => {
                this.inputRef = ref;
            }));
            ...
            this.handleSubmit = (__runInitializers(this, _handleUserChange_extraInitializers), (event) => {
        ...
        render() {
            ...
            return (<react_1.Fragment>
                <Header_1.default small={success}>
                    {(0, index_1.translate)(success ? 'sulu_admin.forgot_password_success' : 'sulu_admin.forgot_password')}
                </Header_1.default>
                <form className={form_scss_1.default.form} onSubmit={this.handleSubmit}>
                    <fieldset>
                        <label className={form_scss_1.default.inputField}>
                            <div className={form_scss_1.default.labelText}>
                                {(0, index_1.translate)('sulu_admin.username_or_email')}
                            </div>
                            <index_3.default autocomplete="username" icon="su-user" inputRef={this.setInputRef} onChange={this.handleUserChange} value={this.user}/>
                        </label>
                        <div className={form_scss_1.default.buttons}>
                            ...
                            <index_2.default disabled={this.submitButtonDisabled} loading={this.props.loading} skin="primary" type="submit">
                                {this.props.success
                    ? (0, index_1.translate)('sulu_admin.reset_resend') : (0, index_1.translate)('sulu_admin.reset')}
                            </index_2.default>
                        </div>
                    </fieldset>
                </form>
    ...
    __setFunctionName(_classThis, "ForgotPasswordForm");
    (() => {
        var _a;
        ...
        ForgotPasswordForm = _classThis = _classDescriptor.value;
    ...
    return ForgotPasswordForm = _classThis;
})();
