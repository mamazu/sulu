...
class ResetPasswordForm extends React.Component<Props> {
    ...
    @action handlePassword1Change = (password1?: string | null) => {
        this.password1 = password1;

        this.errorMessage = null;
    };

    @action handlePassword2Change = (password2?: string | null) => {
        this.password2 = password2;

        this.errorMessage = null;
    };

    @action handleSubmit = (event: React.SyntheticEvent<HTMLFormElement>) => {
