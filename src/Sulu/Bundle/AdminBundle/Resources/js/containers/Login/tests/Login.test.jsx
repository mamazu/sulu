...
test('Should render the Login component when initialized is true', () => {
    ...
    expect((0, enzyme_1.render)(<Login_1.default initialized={true} onLoginSuccess={jest.fn()} router={router}/>)).toMatchSnapshot();
});
test('Should render the component with loader', () => {
    const router = new Router_1.default();
    expect((0, enzyme_1.render)(<Login_1.default initialized={false} onLoginSuccess={jest.fn()} router={router}/>)).toMatchSnapshot();
});
...
test('Should render the Login with forgot password view', () => {
    const router = new Router_1.default();
    const loginForm = (0, enzyme_1.mount)(<Login_1.default initialized={true} onLoginSuccess={jest.fn()} router={router}/>);
...
test('Should render the Login with forgot password with success', () => {
    ...
    const loginForm = (0, enzyme_1.shallow)(<Login_1.default initialized={true} onLoginSuccess={jest.fn()} router={router}/>);
    loginForm.instance().handleChangeToForgotPasswordForm();
    expect(loginForm.render()).toMatchSnapshot();
});
...
test('Should call the submit handler of the login view', () => {
    ...
    const login = (0, enzyme_1.mount)(<Login_1.default initialized={true} onLoginSuccess={jest.fn()} router={router}/>);
