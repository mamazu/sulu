...
test('Should render the component', () => {
    expect((0, enzyme_1.render)(<TwoFactorForm_1.default methods={['emails', 'trusted_devices']} onChangeForm={jest.fn()} onSubmit={jest.fn()}/>)).toMatchSnapshot();
});
test('Should render the component error', () => {
    expect((0, enzyme_1.render)(<TwoFactorForm_1.default error={true} methods={['emails', 'trusted_devices']} onChangeForm={jest.fn()} onSubmit={jest.fn()}/>)).toMatchSnapshot();
});
test('Should trigger onChangeForm correctly', () => {
    const onChangeForm = jest.fn();
    const form = (0, enzyme_1.shallow)(<TwoFactorForm_1.default methods={['emails', 'trusted_devices']} onChangeForm={onChangeForm} onSubmit={jest.fn()}/>);
...
test('Should not trigger onSubmit if autCode is missing', () => {
    ...
    const form = (0, enzyme_1.shallow)(<TwoFactorForm_1.default methods={['emails', 'trusted_devices']} onChangeForm={jest.fn()} onSubmit={onSubmit}/>);
    const event = {
