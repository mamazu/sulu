...
jest.mock('../../../containers/Form', () => (class FormMock extends mockReact.Component<any> {
    render() {
...
jest.mock('../../../containers/Form/stores/ResourceFormStore',
    () => jest.fn(function(resourceStore: any, formKey: any, options: any, metadataOptions: any) {
...
jest.mock('../../../containers/Form/stores/MemoryFormStore',
    () => jest.fn(function(data: any, rawSchema: any, jsonSchema: any, locale: any) {
...
test('Should display Snackbar with generic message if an error happens while saving ResourceFormStore', (done: any) => {
    const formStore = new ResourceFormStore(new ResourceStore('test'), 'test');
    const confirmSpy = jest.fn();
...
test('Should display Snackbar with message from server if an error happens while saving ResourceFormStore', (done: any) => {
    const formStore = new ResourceFormStore(new ResourceStore('test'), 'test');
    const confirmSpy = jest.fn();
