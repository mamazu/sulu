...
jest.mock('../../../containers/List/stores/ListStore', () => jest.fn(
    function(resourceKey: any, listKey: any, userSettingsKey: any, observableOptions: any) {
...
test('Should call the onItemClick callback when an item was clicked', () => {
    ...
    const item1 = {id: 1, title: 'Title 1'} as const;
    const item2 = {id: 2, title: 'Title 2'} as const;
