...
export default class InternalLinkPlugin extends Plugin {
    @observable
    openOverlay: string | null | undefined = undefined;
    @observable
    target: string | null | undefined = DEFAULT_TARGET;
    @observable
    id: string | null | undefined | number = undefined;
    @observable
    ...
    @computed
    get internalLinkTypes(): Array<string> {
        return linkTypeRegistry.getKeys().filter((type) => type !== 'external');
    }

    @computed
    get href(): string | null | undefined | number {
    ...
    @action handleQueryChange = (query?: string | null) => {
        this.query = query;
    };

    @action handleAnchorChange = (anchor?: string | null) => {
        this.anchor = anchor;
    };

    @action handleTargetChange = (target?: string | null) => {
        this.target = target;
    };
    ...
    @action handleHrefChange = (id: string | null | undefined | number, item?: any | null) => {
        this.id = id;
