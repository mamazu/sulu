function addLinkConversion(editor: any, tag: string, internalAttribute: string, tagAttribute: string) {
...
function findModelItemInSelection(editor: any) {
    const firstPosition = editor.model.document.selection.getFirstPosition();
    return firstPosition.textNode || firstPosition.nodeBefore;
}

function findViewLinkItemInSelection(editor: any, linkTag: string) {
