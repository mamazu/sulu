...
exports.addLinkConversion = addLinkConversion;
exports.findModelItemInSelection = findModelItemInSelection;
exports.findViewLinkItemInSelection = findViewLinkItemInSelection;
function addLinkConversion(editor, tag, internalAttribute, tagAttribute) {
...
function findModelItemInSelection(editor) {
    const firstPosition = editor.model.document.selection.getFirstPosition();
    return firstPosition.textNode || firstPosition.nodeBefore;
}
function findViewLinkItemInSelection(editor, linkTag) {
    const selection = editor.editing.view.document.selection;
    const firstPosition = selection.getFirstPosition();
    return firstPosition.getAncestors().find((ancestor) => ancestor.is('attributeElement') && ancestor.name === linkTag);
}
