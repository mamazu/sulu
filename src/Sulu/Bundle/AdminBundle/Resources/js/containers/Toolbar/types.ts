...
export type ButtonItemConfig = (Button) & {
    type: 'button'
};

export type DropdownItemConfig = (Dropdown) & {
    type: 'dropdown'
};

export type SelectItemConfig<T> = (Select<T>) & {
    type: 'select'
};

export type TogglerItemConfig = (Toggler) & {
    type: 'toggler'
};
...
export type ToolbarConfig = {
    ...
    items?: Array<ToolbarItemConfig<any>>,
