...
test('Should return the resourceKey from the ResourceFormStore', () => {
    ...
    const formInspector = new FormInspector_1.default(formStore);
    expect(formInspector.resourceKey).toEqual('test');
});
test('Should return the locale from the ResourceFormStore', () => {
    const formStore = new ResourceFormStore_1.default(new ResourceStore_1.default('test', 1, { locale: mobx_1.observable.box('de') }), 'test');
    const formInspector = new FormInspector_1.default(formStore);
...
test('Should return the id from the ResourceFormStore', () => {
    const formStore = new ResourceFormStore_1.default(new ResourceStore_1.default('test', 3), 'test');
    const formInspector = new FormInspector_1.default(formStore);
...
test('Should return the metadataOptions from the ResourceFormStore', () => {
    const formStore = new ResourceFormStore_1.default(new ResourceStore_1.default('test', 1), 'test');
...
test('Should call registered onFinishField handlers', () => {
    const formInspector = new FormInspector_1.default(new ResourceFormStore_1.default(new ResourceStore_1.default('test', 3), 'test'));
