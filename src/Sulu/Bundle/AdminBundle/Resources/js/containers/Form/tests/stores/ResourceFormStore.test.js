...
beforeEach(() => {
    metadataStore_1.default.getSchema = jest.fn().mockReturnValue(Promise.resolve({}));
    metadataStore_1.default.getJsonSchema = jest.fn().mockReturnValue(Promise.resolve({}));
    metadataStore_1.default.getSchemaTypes = jest.fn().mockReturnValue(Promise.resolve(null));
});
test('Create data object for schema', (done) => {
    ...
    metadataStore_1.default.getSchema.mockReturnValue(metadataPromise);
    const resourceStore = new ResourceStore_1.default('snippets', '1');
    const resourceFormStore = new ResourceFormStore_1.default(resourceStore, 'snippets');
...
test('Create data object for schema with sections', () => {
    ...
    metadataStore_1.default.getSchemaTypes.mockReturnValue(schemaTypesPromise);
    const metadataPromise = Promise.resolve(metadata);
    metadataStore_1.default.getSchema.mockReturnValue(metadataPromise);
    const resourceFormStore = new ResourceFormStore_1.default(new ResourceStore_1.default('snippets', '1'), 'snippets');
...
test('Change schema should keep data', (done) => {
    ...
    const resourceStore = new ResourceStore_1.default('snippets', '1');
    resourceStore.data = (0, mobx_1.observable)({
        title: 'Title',
        slogan: 'Slogan',
    });
    const metadataPromise = Promise.resolve(metadata);
...
test('Change type should update schema and data', (done) => {
    ...
    metadataStore_1.default.getSchema.mockReturnValue(sidebarPromise);
...
test('Change schema should update data and use remoteData for invalid blocks', (done) => {
    ...
    const jsonSchemaPromise = Promise.resolve({});
    const resourceStore = new ResourceStore_1.default('pages', '1');
    resourceStore.data = (0, mobx_1.observable)({
        title: 'Title',
        blocks: [
    ...
    metadataStore_1.default.getSchema.mockReturnValue(newSchemaPromise);
    metadataStore_1.default.getJsonSchema.mockReturnValue(jsonSchemaPromise);
    const resourceFormStore = new ResourceFormStore_1.default(resourceStore, 'pages');
...
test('Change type should throw an error if no types are available', () => {
    ...
    metadataStore_1.default.getSchema.mockReturnValue(promise);
    const resourceStore = new ResourceStore_1.default('snippets', '1');
    const resourceFormStore = new ResourceFormStore_1.default(resourceStore, 'snippets');
    return promise.then(() => {
...
test('types property should be returning types from server', () => {
    ...
    metadataStore_1.default.getSchemaTypes.mockReturnValue(promise);
    const resourceFormStore = new ResourceFormStore_1.default(new ResourceStore_1.default('snippets', '1'), 'snippets');
    expect((0, mobx_1.toJS)(resourceFormStore.types)).toEqual({});
    expect(resourceFormStore.typesLoading).toEqual(true);
    return promise.then(() => {
        expect((0, mobx_1.toJS)(resourceFormStore.types)).toEqual(types);
...
test('Loading flag should be set to true as long as schema is loading', () => {
    const resourceFormStore = new ResourceFormStore_1.default(new ResourceStore_1.default('snippets', '1', { locale: mobx_1.observable.box() }), 'snippets');
...
test('Save the store should call the resourceStore save function', () => {
    const resourceFormStore = new ResourceFormStore_1.default(new ResourceStore_1.default('snippets', '3', { locale: mobx_1.observable.box() }), 'snippets');
...
test('Save the store should call the resourceStore save function with the passed options', () => {
    const resourceFormStore = new ResourceFormStore_1.default(new ResourceStore_1.default('snippets', '3', { locale: mobx_1.observable.box() }), 'snippets', { option1: 'value1', option2: 'value2' });
...
test('Save the store should reject if request has failed', (done) => {
    ...
    (0, mobx_1.when)(() => !resourceFormStore.schemaLoading, () => {
        const savePromise = resourceFormStore.save();
        savePromise.catch(() => {
            expect((0, mobx_1.toJS)(resourceFormStore.errors)).toEqual({});
        });
...
test('Validate should not return incorrect errors', (done) => {
    ...
    (0, mobx_1.when)(() => !resourceFormStore.schemaLoading, () => {
        expect(resourceFormStore.validate()).toEqual(false);
        expect((0, mobx_1.toJS)(resourceFormStore.errors.blocks)[0]).toHaveProperty('text');
        expect((0, mobx_1.toJS)(resourceFormStore.errors.blocks)[0]).not.toHaveProperty('title');
        expect((0, mobx_1.toJS)(resourceFormStore.errors.blocks)[0]).not.toHaveProperty('type');
        done();
    });
});
...
test('Delete should delegate the call to resourceStore with options', () => {
    ...
    const resourceStore = new ResourceStore_1.default('snippets', 3);
    resourceStore.delete.mockReturnValue(deletePromise);
    const resourceFormStore = new ResourceFormStore_1.default(resourceStore, 'snippets', { webspace: 'sulu_io' });
...
test('Data attribute should return the data from the resourceStore', () => {
    const resourceFormStore = new ResourceFormStore_1.default(new ResourceStore_1.default('snippets', '3'), 'snippets');
    resourceFormStore.resourceStore.data = (0, mobx_1.observable)({
        title: 'Title',
    });
...
test('Destroying the store should call all the disposers', () => {
    const resourceFormStore = new ResourceFormStore_1.default(new ResourceStore_1.default('snippets', '2'), 'snippets');
...
test('Should return value for property path', () => {
    const resourceStore = new ResourceStore_1.default('test', 3);
    resourceStore.data = (0, mobx_1.observable)({ test: 'value' });
    const resourceFormStore = new ResourceFormStore_1.default(resourceStore, 'snippets');
...
test('Return SchemaEntry for given schemaPath', (done) => {
    ...
    metadataStore_1.default.getSchema.mockReturnValue(metadataPromise);
    const resourceFormStore = new ResourceFormStore_1.default(new ResourceStore_1.default('test'), 'snippets');
    setTimeout(() => {
...
test('HasInvalidType return true when invalid type is set', () => {
    ...
    metadataStore_1.default.getSchemaTypes.mockReturnValue(schemaTypesPromise);
    const resourceStore = new ResourceStore_1.default('test', 1);
    const resourceFormStore = new ResourceFormStore_1.default(resourceStore, 'test');
...
test('HasTypes return true when types are set', () => {
    ...
    metadataStore_1.default.getSchemaTypes.mockReturnValue(schemaTypesPromise);
    const resourceStore = new ResourceStore_1.default('test', 5);
    const resourceFormStore = new ResourceFormStore_1.default(resourceStore, 'snippets');
    return schemaTypesPromise.then(() => {
...
test('Set type to the template value if set', () => {
    ...
    metadataStore_1.default.getSchemaTypes.mockReturnValue(schemaTypesPromise);
    const resourceStore = new ResourceStore_1.default('test', 5);
    resourceStore.data = (0, mobx_1.observable)({ template: 'footer' });
    const resourceFormStore = new ResourceFormStore_1.default(resourceStore, 'snippets');
    return schemaTypesPromise.then(() => {
        expect(resourceFormStore.type).toEqual('footer');
    });
