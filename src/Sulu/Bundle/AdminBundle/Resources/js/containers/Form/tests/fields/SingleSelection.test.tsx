...
jest.mock('../../../../stores/ResourceStore', () => jest.fn(function(resourceKey: any, id: any, locale: any) {
    this.resourceKey = resourceKey;
    this.id = id;
    this.locale = locale;
}));

jest.mock('../../../../stores/SingleSelectionStore', () => jest.fn(function(resourceKey: any, selectedItemId: any, locale: any) {
    this.resourceKey = resourceKey;
    this.locale = locale;
    this.set = jest.fn();
    this.loading = false;
...
jest.mock('../../stores/ResourceFormStore', () => jest.fn(function(resourceStore: any, formKey: any, options: any) {
...
jest.mock('../../FormInspector', () => jest.fn(function(formStore: any) {
...
test('Pass correct props with schema-options type to SingleItemSelection', () => {
    ...
    const formInspectorValues = {'/otherPropertyName': 'value-returned-by-form-inspector'} as const;
    formInspector.getValueByPath.mockImplementation((path: any) => formInspectorValues[path]);
...
test('Should update props of SingleItemSelection when value of "resource_store_properties_to_request" property is changed', () => {
    ...
    const formInspectorValues = {'/otherPropertyName': 'first-value'} as const;
    formInspector.getValueByPath.mockImplementation((path: any) => formInspectorValues[path]);
