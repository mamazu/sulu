...
jest.mock('../../../../stores/MultiSelectionStore', () => jest.fn(
    function(resourceKey: any, selectedItemIds: any, locale: any, idFilterParameter: any) {
        this.locale = locale;
        this.loading = false;
...
jest.mock('../../stores/ResourceFormStore', () => jest.fn(function(resourceStore: any) {
    this.id = resourceStore.id;
    this.resourceKey = resourceStore.resourceKey;
    this.locale = resourceStore.locale;
}));

jest.mock('../../../../stores/ResourceStore', () => jest.fn(function(resourceKey: any, id: any, options: any) {
    this.id = id;
    this.resourceKey = resourceKey;
