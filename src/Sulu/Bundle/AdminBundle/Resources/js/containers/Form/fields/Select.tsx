...
type Props = FieldTypeProps<Array<string | number> | null | undefined>;

export default class Select extends React.Component<Props> {
    constructor(props: FieldTypeProps<Array<string | number> | null | undefined>) {
        super(props);
    ...
    @computed
    get values(): Array<any> | IObservableArray<any> {
