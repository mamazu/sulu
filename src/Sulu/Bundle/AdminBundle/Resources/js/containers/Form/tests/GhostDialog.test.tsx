...
test('Should render a Dialog', (resolve: any) => {
...
test('Should call onConfirm callback with chosen locale if user chooses to copy content', (resolve: any) => {
...
test('Should call onConfirm callback with chosen locale if user chooses to copy content (with additional fields)', (resolve: any) => { // eslint-disable-line max-len
    const formMetadata = {
        ...FORM,
        title: {
            label: 'Test',
