...
test('Render with loaded changer and creator', () => {
    ...
    formInspector.getValueByPath.mockImplementation((path: any) => {
        switch (path) {
            case '/creator':
                return 1;
            case '/changer':
    ...
    ResourceRequester.get.mockImplementation((resourceKey: any, {
        id,
    }: any) => {
        switch (id) {
            case 1:
...
test('Render with deleted changer and existing creator', (done: any) => {
    const formInspector = new FormInspector(new ResourceFormStore(new ResourceStore('test'), 'test'));
...
test('Render with existing changer and deleted creator', (done: any) => {
    const formInspector = new FormInspector(new ResourceFormStore(new ResourceStore('test'), 'test'));
