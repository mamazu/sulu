...
class Selection extends React.Component<Props> {
    listStore: ListStore | null | undefined;
    autoCompleteSelectionStore: MultiSelectionStore<string | number> | null | undefined;
    changeListDisposer: () => any | null | undefined;
    changeAutoCompleteSelectionDisposer: () => any | null | undefined;
    changeListOptionsDisposer: () => any | null | undefined;
    changeLocaleDisposer: () => any | null | undefined;
    ...
    @computed
    get value(): Value | null | undefined {
    ...
    handleItemClick = (itemId: string | number, item: any) => {
    ...
    renderListOverlay() {
        ...
        const options = {...this.requestOptions} as const;
        if (types) {
            options.types = types;
        }
