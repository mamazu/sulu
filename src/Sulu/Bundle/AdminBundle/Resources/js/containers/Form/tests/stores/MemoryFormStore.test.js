...
test('Create data object for schema', () => {
    ...
    const memoryFormStore = new MemoryFormStore_1.default({}, schema);
...
test('Create data object for schema while keeping existing data', () => {
    ...
    const memoryFormStore = new MemoryFormStore_1.default({ title: 'Test' }, schema);
    expect(memoryFormStore.loading).toEqual(false);
...
test('Asking for resourceKey should return undefined', () => {
    const memoryFormStore = new MemoryFormStore_1.default({}, {});
...
test('Data attribute should return the data', () => {
    const data = (0, mobx_1.observable)({
        title: 'Title',
    });
    const memoryFormStore = new MemoryFormStore_1.default(data, {});
    expect(memoryFormStore.data).toBe(data);
});
test('Should return value for property path', () => {
    const memoryFormStore = new MemoryFormStore_1.default((0, mobx_1.observable)({ test: 'value' }), {});
...
test('Return all the values for a given tag', () => {
    ...
    const memoryFormStore = new MemoryFormStore_1.default(data, schema);
...
test('Validate should return true if no errors occured', () => {
    const memoryFormStore = new MemoryFormStore_1.default({ title: 'Test' }, {}, { type: 'object', required: ['title'] });
...
test('Validate should return false if errors occured', () => {
    const memoryFormStore = new MemoryFormStore_1.default({}, {}, { type: 'object', required: ['title'] });
