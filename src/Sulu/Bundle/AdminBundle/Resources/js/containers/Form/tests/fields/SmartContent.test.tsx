...
jest.mock('../../../../stores/ResourceStore', () => jest.fn(function(resourceKey: any, id: any) {
...
jest.mock('../../stores/ResourceFormStore', () => jest.fn(function(resourceStore: any, formKey: any, options: any, metadataOptions: any) {
