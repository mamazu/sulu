...
let Heading = (() => {
    ...
    var Heading = _classThis = class extends _classSuper {
        get schemaOptions() {
            return this.props.schemaOptions;
        }
        get description() {
            var _a;
            return (_a = this.schemaOptions.description) === null || _a === void 0 ? void 0 : _a.title;
        }
        get icon() {
            var _a;
            const icon = (_a = this.schemaOptions.icon) === null || _a === void 0 ? void 0 : _a.value;
        ...
        render() {
            ...
            return (<Heading_1.default description={this.description} icon={this.icon} label={this.label}>
                {children}
            </Heading_1.default>);
        }
        constructor() {
    ...
    __setFunctionName(_classThis, "Heading");
    (() => {
        var _a;
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _get_schemaOptions_decorators = [mobx_1.computed];
        _get_description_decorators = [mobx_1.computed];
        ...
        __esDecorate(_classThis, null, _get_description_decorators, { kind: "getter", name: "description", static: false, private: false, access: { has: obj => "description" in obj, get: obj => obj.description }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _get_icon_decorators, { kind: "getter", name: "icon", static: false, private: false, access: { has: obj => "icon" in obj, get: obj => obj.icon }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        Heading = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Heading = _classThis;
})();
