...
class Field extends React.Component<Props> {
    ...
    handleChange = (value: any, context?: ChangeContext) => {
    ...
    handleFinish = (subDataPath?: string | null, subSchemaPath?: string | null) => {
    ...
    findErrorKeyword(error: Error | null | undefined | ErrorCollection): string | null | undefined {
        if (!error) {
            return;
        }
