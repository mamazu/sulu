...
test('Should render a Dialog', () => {
    ...
    const missingTypeDialog = (0, enzyme_1.mount)(<MissingTypeDialog_1.default onCancel={jest.fn()} onConfirm={jest.fn()} open={true} types={types}/>);
...
test('Should call onCancel callback if user chooses not to change type', () => {
    ...
    const missingTypeDialog = (0, enzyme_1.mount)(<MissingTypeDialog_1.default onCancel={cancelSpy} onConfirm={jest.fn()} open={true} types={types}/>);
...
test('Should call onConfirm callback with chosen type if user chooses to change type', () => {
    ...
    const missingTypeDialog = (0, enzyme_1.mount)(<MissingTypeDialog_1.default onCancel={jest.fn()} onConfirm={confirmSpy} open={true} types={types}/>);
