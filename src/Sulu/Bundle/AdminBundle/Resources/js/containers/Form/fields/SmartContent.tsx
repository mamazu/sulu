...
type Props = FieldTypeProps<FilterCriteria | null | undefined>;

class SmartContent extends React.Component<Props> {
    smartContentStore: SmartContentStore;
    filterCriteriaChangeDisposer: () => unknown;
    ...
    handleFilterCriteriaChange = (filterCriteria?: FilterCriteria | null) => {
