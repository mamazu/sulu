...
jest.mock('../FormInspector', () => jest.fn(function(resourceFormStore: any) {
...
test('Render the section if visibleCondition with conditionDataProvider evaluates to true', () => {
    ...
    conditionDataProviderRegistry.add((data: any) => ({__test: data.test}));
