...
jest.mock('../../../stores/ResourceStore', () => jest.fn(function(resourceKey: any, id: any, observableOptions = {}) {
...
test.each([
    ['draft'],
    ['publish'],
])('Call saveHandlers with the action "%s" as argument when form is submitted', (action: any) => {
...
test('Should show a GhostDialog and copy the content if the confirm button is clicked', (resolve: any) => {
...
test('Should show a GhostDialog and copy the content if the confirm button is clicked (with additional fields)', (resolve: any) => { // eslint-disable-line max-len
    const formMetadata = {
        ...FORM,
        title: {
            label: 'Test',
