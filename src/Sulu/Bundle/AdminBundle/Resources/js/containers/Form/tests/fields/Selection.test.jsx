...
jest.mock('../../../../stores/MultiSelectionStore', () => jest.fn(function (resourceKey, selectedItemIds, locale, idFilterParameter) {
    this.locale = locale;
    this.loading = false;
...
jest.mock('../../../List/stores/ListStore', () => (function (resourceKey, listKey, userSettingsKey, observableOptions = {}, options, metadataOptions, initialSelectionIds) {
...
test('Should pass props correctly to MultiSelection component', () => {
    ...
    const formInspector = new FormInspector_1.default(new ResourceFormStore_1.default(new ResourceStore_1.default('pages', 1, { locale }), 'pages'));
    const selection = (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} disabled={true} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector} onFinish={jest.fn()} schemaOptions={schemaOptions} value={value}/>);
    expect(Translator_1.translate).toBeCalledWith('sulu_snippet.selection_label', { count: 3 });
...
test('Should pass resourceKey as listKey to selection component if no listKey is given', () => {
    ...
    const locale = mobx_1.observable.box('en');
    const formInspector = new FormInspector_1.default(new ResourceFormStore_1.default(new ResourceStore_1.default('pages', 1, { locale }), 'pages'));
    const selection = (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} disabled={true} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector} onFinish={jest.fn()} value={value}/>);
...
test('Should pass locale from userStore to MultiSelection component if form has no locale', () => {
    ...
    const formInspector = new FormInspector_1.default(new ResourceFormStore_1.default(new ResourceStore_1.default('pages', 1), 'pages'));
    userStore_1.default.contentLocale = 'de';
    const selection = (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} disabled={true} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector} onFinish={jest.fn()} value={value}/>);
    expect(Translator_1.translate).toBeCalledWith('sulu_snippet.selection_label', { count: 3 });
    expect((0, mobx_1.toJS)(selection.find('MultiSelection').prop('locale'))).toEqual('de');
});
...
test('Should pass id of form as disabledId to MultiSelection component to avoid assigning something to itself', () => {
    ...
    const selection = (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector}/>);
...
test('Should pass empty array to MultiSelection component if value is not given', () => {
    ...
    const selection = (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} fieldTypeOptions={fieldOptions} formInspector={formInspector} onChange={changeSpy}/>);
    expect(Translator_1.translate).toBeCalledWith('sulu_page.selection_label', { count: 0 });
    expect(selection.find('MultiSelection').props()).toEqual(expect.objectContaining({
        adapter: 'column_list',
        resourceKey: 'pages',
        value: [],
...
test('Should call onChange and onFinish callback when MultiSelection component fires onChange callback', () => {
    ...
    const formInspector = new FormInspector_1.default(new ResourceFormStore_1.default(new ResourceStore_1.default('snippets'), 'pages'));
    const selection = (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} fieldTypeOptions={fieldOptions} formInspector={formInspector} onChange={changeSpy} onFinish={finishSpy}/>);
...
test('Should not fail when MultiSelection item is clicked without configured view', () => {
    ...
    const selection = (0, enzyme_1.mount)(<Selection_1.default {...fieldTypeDefaultProps_1.default} fieldTypeOptions={fieldOptions} formInspector={formInspector} onChange={changeSpy} onFinish={finishSpy} router={router} value={[1, 2]}/>);
...
test('Should log warning and use ids of objects if given value is an array of objects', () => {
    ...
    const selection = (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector} value={[{ id: 55 }, { id: 66 }]}/>);
    expect(selection.find('MultiSelection').prop('value')).toEqual([55, 66]);
    expect(loglevel_1.default.warn).toBeCalledWith(expect.stringContaining('expects an array of ids as value'));
});
test('Should throw an error if "types" schema option is not a string', () => {
    ...
    expect(() => (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector} schemaOptions={{ types: { name: 'type', value: [] } }}/>)).toThrowError(/"types"/);
});
test('Should throw an error if "item_disabled_condition" schema option is not a string', () => {
    ...
    expect(() => (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector} schemaOptions={{ item_disabled_condition: { name: 'item_disabled_condition', value: [] } }}/>)).toThrowError(/"item_disabled_condition"/);
});
test('Should throw an error if "allow_deselect_for_disabled_items" schema option is not a boolean', () => {
    ...
    expect(() => (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector} schemaOptions={schemaOptions}/>)).toThrowError(/"allow_deselect_for_disabled_items"/);
});
test('Should throw an error if "sortable" schema option is not a boolean', () => {
    ...
    expect(() => (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector} schemaOptions={schemaOptions}/>)).toThrowError(/"sortable"/);
});
test('Should throw an error if "request_parameters" schema option is not an array', () => {
    ...
    expect(() => (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector} schemaOptions={{ request_parameters: { name: 'request_parameters', value: 'not-an-array' } }}/>)).toThrowError(/"request_parameters"/);
});
test('Should throw an error if "resource_store_properties_to_request" schema option is not an array', () => {
    ...
    expect(() => (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector} schemaOptions={schemaOptions}/>)).toThrowError(/"resource_store_properties_to_request"/);
});
test('Should throw an error if no "resource_key" option is passed in fieldOptions', () => {
    const formInspector = new FormInspector_1.default(new ResourceFormStore_1.default(new ResourceStore_1.default('snippets'), 'pages'));
    expect(() => (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} fieldTypeOptions={{ default_type: 'list_overlay' }} formInspector={formInspector}/>)).toThrowError(/"resource_key"/);
});
test('Should throw an error if no "adapter" option is passed for overlay type in fieldTypeOptions', () => {
    ...
    expect(() => (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector}/>)).toThrowError(/"adapter"/);
});
test('Should call the disposers for list selections and locale and ListStore if unmounted', () => {
    ...
    const selection = (0, enzyme_1.mount)(<Selection_1.default {...fieldTypeDefaultProps_1.default} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector}/>);
...
test('Should call sendRequestDisposer to avoid extra request when locale is changed', () => {
    ...
    const locale = mobx_1.observable.box('en');
    const formInspector = new FormInspector_1.default(new ResourceFormStore_1.default(new ResourceStore_1.default('pages', 1, { locale }), 'pages'));
    const selection = (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector} onChange={changeSpy} onFinish={finishSpy}/>);
    locale.set('de');
...
test('Should pass correct props to list component', () => {
    ...
    const locale = mobx_1.observable.box('en');
    const formInspector = new FormInspector_1.default(new ResourceFormStore_1.default(new ResourceStore_1.default('pages', 1, { locale }), 'pages'));
    const selection = (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} disabled={true} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector} schemaOptions={schemaOptions} value={value}/>);
    expect(selection.find(List_1.default).props()).toEqual(expect.objectContaining({
        adapters: ['table'],
        disabled: true,
        itemDisabledCondition: 'status == "inactive"',
        searchable: false,
...
test('Should pass resourceKey as listKey to listStore if no listKey is given', () => {
    ...
    const locale = mobx_1.observable.box('en');
    const formInspector = new FormInspector_1.default(new ResourceFormStore_1.default(new ResourceStore_1.default('pages', 1, { locale }), 'pages'));
    const selection = (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} disabled={true} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector} value={value}/>);
...
test('Should pass locale from userStore to listStore if form has no locale', () => {
    ...
    const selection = (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} disabled={true} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector} value={value}/>);
    expect((0, mobx_1.toJS)(selection.instance().listStore.locale)).toEqual('en');
});
...
test('Should pass props correctly to MultiAutoComplete component', () => {
    ...
    expect(MultiSelectionStore_1.default).toBeCalledWith('snippets', value, locale, 'names');
});
...
test('Throw an error if a none string was passed to schema-options', () => {
    ...
    expect(() => (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} disabled={true} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector} schemaOptions={schemaOptions} value={value}/>)).toThrow(/"type"/);
});
test('Throw an error if a none string was passed to field-type-options', () => {
    ...
    const locale = mobx_1.observable.box('en');
    const formInspector = new FormInspector_1.default(new ResourceFormStore_1.default(new ResourceStore_1.default('pages', 1, { locale }), 'pages'));
    expect(() => (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} disabled={true} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector} value={value}/>)).toThrow(/"default_type"/);
});
test('Should call onChange and onFinish callback when content of selectionStore has changed', () => {
    ...
    const formInspector = new FormInspector_1.default(new ResourceFormStore_1.default(new ResourceStore_1.default('snippets'), 'pages'));
    const selection = (0, enzyme_1.mount)(<Selection_1.default {...fieldTypeDefaultProps_1.default} fieldTypeOptions={fieldOptions} formInspector={formInspector} onChange={changeSpy} onFinish={finishSpy}/>);
...
test('Should pass allowAdd prop to MultiAutoComplete component', () => {
    ...
    const locale = mobx_1.observable.box('en');
    const formInspector = new FormInspector_1.default(new ResourceFormStore_1.default(new ResourceStore_1.default('pages', 1, { locale }), 'pages'));
    const selection = (0, enzyme_1.shallow)(<Selection_1.default {...fieldTypeDefaultProps_1.default} fieldTypeOptions={fieldTypeOptions} formInspector={formInspector} onChange={jest.fn()} onFinish={jest.fn()} value={value}/>);
    expect(selection.find('MultiAutoComplete').props()).toEqual(expect.objectContaining({
        allowAdd: true,
    }));
});
