...
@observer
class CardCollection extends React.Component<FieldTypeProps<Array<any>>> {
    @observable
    overlayIndex: number | typeof undefined = undefined;
    @observable
    formStore: FormStoreInterface | null | undefined = undefined;
    formRef: ElementRef<typeof Form> | null | undefined;

    constructor(props: FieldTypeProps<Array<any>>) {
        super(props);
    ...
    setFormRef = (formRef?: ElementRef<typeof Form> | null) => {
