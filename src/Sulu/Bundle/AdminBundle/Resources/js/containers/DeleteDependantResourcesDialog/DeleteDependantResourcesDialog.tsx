...
class DeleteDependantResourcesDialog extends React.Component<Props> {
    ...
    @observable
    error: string | typeof undefined = undefined;
    @observable
    closed: boolean = false;
    @observable
    totalDeletedResources: number = 0;
    ...
    @computed
    get dependantResourceBatches(): DependantResourceBatches {
        return this.props.dependantResourcesData.dependantResourceBatches;
    }

    @computed
    get dependantResourcesCount(): number {
    ...
    @computed
    get snackbarType(): SnackbarType | typeof undefined {
    ...
    @computed
    get snackbarMessage(): string | typeof undefined {
