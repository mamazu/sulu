...
class FieldFilterItem extends React.Component<Props> {
    @observable
    value: unknown;
    fieldFilterType: AbstractFieldFilterType<any>;
    valueDisposer: () => void;
    valueNodeDisposer: () => void;
    @observable
    valueNodeLoading: boolean = false;
    @observable
    ...
    @action setValueNode(valueNode?: Node | null) {
        this.valueNode = valueNode;
    }

    @action handleFieldFilterTypeChange = (value: unknown) => {
        this.value = value;
    };
