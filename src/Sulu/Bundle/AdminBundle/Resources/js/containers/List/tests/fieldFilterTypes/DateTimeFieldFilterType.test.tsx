...
])('Render with from and to value', (from: any, to: any, timeFormatEnabled: any) => {
...
])('Render with value set by setValue', (from: any, to: any, timeFormatEnabled: any) => {
    const dateFieldFilterType = new DateFieldFilterType(
        jest.fn(),
        {},
        undefined,
...
test.each([
    ...
    ['2017-06-03', false],
])('Call onChange handler with only from value', (from: any, timeFormatEnabled: any) => {
...
test.each([
    ['2017-06-03 12:00', true],
    ['2017-06-03', false],
])('Call onChange handler with only to value', (to: any, timeFormatEnabled: any) => {
    const changeSpy = jest.fn();
    const dateFieldFilterType = new DateFieldFilterType(changeSpy, {}, undefined, {timeFormat: timeFormatEnabled});
    const dateFieldFilterTypeForm = mount(dateFieldFilterType.getFormNode());
...
test.each([
    ...
    [{}, null, false],
])('Return value node with value "%s"', (value: any, expectedValueNode: any, timeFormatEnabled: any) => {
    ...
    return valueNodePromise.then((valueNode: any) => {
