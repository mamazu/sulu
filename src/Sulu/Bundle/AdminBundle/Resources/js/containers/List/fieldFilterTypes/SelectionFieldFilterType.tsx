...
class SelectionFieldFilterType extends AbstractFieldFilterType<Array<string | number> | null | undefined> {
    ...
    constructor(
        onChange: (value?: Array<string | number> | null | undefined) => void,
        parameters?: {
            [key: string]: unknown
        } | null,
    ...
    getValueNode(value?: Array<string | number> | null) {
        if (!value) {
