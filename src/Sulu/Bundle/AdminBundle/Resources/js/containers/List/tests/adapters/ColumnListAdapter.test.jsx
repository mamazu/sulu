...
test('Render different kind of data with edit button', () => {
    ...
    const columnListAdapter = (0, enzyme_1.render)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[2, 4]} adapterOptions={{ get_indicators: (item) => item.hasChildren ? ['has-children-indicator'] : [] }} data={data} onItemAdd={jest.fn()} onItemClick={jest.fn()} onRequestItemDelete={jest.fn()}/>);
...
test('Render correct icon in edit button based on permissions', () => {
    ...
    const columnListAdapter = (0, enzyme_1.mount)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[]} data={data} onItemClick={jest.fn()}/>);
...
test('Render data without edit button', () => {
    ...
    const columnListAdapter = (0, enzyme_1.render)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[]} data={data} onRequestItemDelete={jest.fn()}/>);
    expect(columnListAdapter).toMatchSnapshot();
});
test('Render data with name as fallback for title', () => {
    ...
    const columnListAdapter = (0, enzyme_1.render)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[]} data={data}/>);
    expect(columnListAdapter).toMatchSnapshot();
});
test('Render data with selection', () => {
    ...
    const columnListAdapter = (0, enzyme_1.render)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[]} data={data} onItemSelectionChange={jest.fn()} onRequestItemDelete={jest.fn()} selections={[1]}/>);
    expect(columnListAdapter).toMatchSnapshot();
});
test('Render data with disabled items', () => {
    ...
    const columnListAdapter = (0, enzyme_1.render)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[1, 3]} data={data} disabledIds={[3]} onItemSelectionChange={jest.fn()} onRequestItemDelete={jest.fn()} selections={[1]}/>);
    expect(columnListAdapter).toMatchSnapshot();
});
test('Render with add button in toolbar when onItemAdd callback is given', () => {
    ...
    const columnListAdapter = (0, enzyme_1.render)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[]} data={data} onItemAdd={jest.fn()} onRequestItemDelete={jest.fn()}/>);
    expect(columnListAdapter).toMatchSnapshot();
});
test('Render without add button in toolbar when onItemAdd callback is given but permission is not granted', () => {
    ...
    const columnListAdapter = (0, enzyme_1.mount)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[undefined, 1, 4]} data={data} onItemAdd={jest.fn()} onRequestItemDelete={jest.fn()}/>);
...
test('Render without toolbar for first column if display_root_level_toolbar option is set', () => {
    ...
    const columnListAdapter = (0, enzyme_1.mount)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[undefined, 1, 4]} adapterOptions={{ display_root_level_toolbar: false }} data={data} onItemAdd={jest.fn()} onRequestItemDelete={jest.fn()}/>);
...
test('Render without toolbar when all actions would be deactivated', () => {
    ...
    const columnListAdapter = (0, enzyme_1.mount)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[undefined]} data={data}/>);
...
test('Render data with loading column', () => {
    ...
    const columnListAdapter = (0, enzyme_1.render)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[1]} data={data} loading={true} onRequestItemDelete={jest.fn()}/>);
    expect(columnListAdapter).toMatchSnapshot();
});
test('Execute onItemActivate callback when an item is clicked with the correct parameter', () => {
    ...
    const columnListAdapter = (0, enzyme_1.mount)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[1, 3]} data={data} onItemActivate={itemActivateSpy}/>);
...
test('Execute onItemClick callback when an item is double-clicked', () => {
    ...
    const columnListAdapter = (0, enzyme_1.mount)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[1, 3]} data={data} onItemClick={itemClickSpy}/>);
...
test('Show all setting buttons', () => {
    ...
    const columnListAdapter = (0, enzyme_1.mount)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[undefined, 1]} data={data} onRequestItemCopy={jest.fn()} onRequestItemDelete={jest.fn()} onRequestItemMove={jest.fn()} onRequestItemOrder={jest.fn()}/>);
...
test('Disable sort button if edit permission on parent is missing', () => {
    ...
    const columnListAdapter = (0, enzyme_1.mount)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[undefined, 1, 2]} data={data} onRequestItemCopy={jest.fn()} onRequestItemDelete={jest.fn()} onRequestItemMove={jest.fn()} onRequestItemOrder={jest.fn()}/>);
...
test('Do not show order button if onRequestItemOrder callback is undefined', () => {
    ...
    const columnListAdapter = (0, enzyme_1.mount)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[1, 3]} data={data} onRequestItemMove={jest.fn()} onRequestItemOrder={undefined}/>);
    columnListAdapter.find('Toolbar ToolbarDropdown').simulate('click');
...
test('Call onRequestItemOrder callback when an item ordering has been changed', () => {
    ...
    const columnListAdapter = (0, enzyme_1.mount)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[1, 3]} data={data} onRequestItemOrder={requestItemOrderSpy}/>);
...
test('Do not execute onItemActivate callback when a column is ordering', () => {
    ...
    const columnListAdapter = (0, enzyme_1.mount)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[1, 3]} data={data} onItemActivate={itemActivateSpy} onRequestItemOrder={jest.fn()}/>);
    columnListAdapter.find('Toolbar ToolbarDropdown button').simulate('click');
    columnListAdapter.find('ToolbarDropdown').find('ArrowMenu Action[children="sulu_admin.order"]').prop('onClick')(0);
...
test('Execute onItemSelectionChange callback when an item is selected', () => {
    ...
    const columnListAdapter = (0, enzyme_1.mount)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[]} data={data} onItemSelectionChange={itemSelectionChangeSpy} selections={[2]}/>);
...
test('Execute onRequestItemCopy callback when an item is copied with the correct id', () => {
    ...
    const columnListAdapter = (0, enzyme_1.mount)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[1, 3]} data={data} onRequestItemCopy={copyClickSpy}/>);
...
test('Execute onRequestItemMove callback when an item is moved with the correct id', () => {
    ...
    const columnListAdapter = (0, enzyme_1.mount)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[1, 3]} data={data} onRequestItemMove={moveClickSpy}/>);
    columnListAdapter.find('ToolbarDropdown button').simulate('click');
...
test('Execute onRequestItemDelete callback when an item is deleted with the correct id', () => {
    ...
    const columnListAdapter = (0, enzyme_1.mount)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[1, 3]} data={data} onRequestItemDelete={deleteClickSpy}/>);
    columnListAdapter.find('ToolbarDropdown button').simulate('click');
...
test('Enable delete and move button if an item in this column has been activated', () => {
    ...
    const columnListAdapter = (0, enzyme_1.mount)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[1, 3]} data={data} onRequestItemDelete={jest.fn()} onRequestItemMove={jest.fn()}/>);
    columnListAdapter.find('Toolbar ToolbarDropdown button').simulate('click');
...
test('Disable delete and move button if no item in this column has been activated', () => {
    ...
    const columnListAdapter = (0, enzyme_1.mount)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[1]} data={data} onRequestItemDelete={jest.fn()} onRequestItemMove={jest.fn()}/>);
    columnListAdapter.find('Toolbar ToolbarDropdown button').simulate('click');
...
test('Do not show settings if no options are available', () => {
    const columnListAdapter = (0, enzyme_1.mount)(<ColumnListAdapter_1.default {...listAdapterDefaultProps_1.default} activeItems={[1]}/>);
