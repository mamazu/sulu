...
test('Render with value of undefined', () => {
    const dateFieldFilterType = new DateFieldFilterType_1.default(jest.fn(), {}, undefined, { timeFormat: true });
    expect((0, enzyme_1.mount)(<div>{dateFieldFilterType.getFormNode()}</div>).render()).toMatchSnapshot();
});
test.each([
    ...
    const dateFieldFilterType = new DateFieldFilterType_1.default(jest.fn(), {}, { from, to }, { timeFormat: timeFormatEnabled });
    expect((0, enzyme_1.mount)(<div>{dateFieldFilterType.getFormNode()}</div>).render()).toMatchSnapshot();
});
test.each([
    ...
    const dateFieldFilterType = new DateFieldFilterType_1.default(jest.fn(), {}, undefined, { timeFormat: timeFormatEnabled });
...
test.each([
    ...
    const dateFieldFilterType = new DateFieldFilterType_1.default(changeSpy, {}, undefined, { timeFormat: timeFormatEnabled });
    const dateFieldFilterTypeForm = (0, enzyme_1.mount)(dateFieldFilterType.getFormNode());
...
])('Call onChange handler with from value and existing value', (fromActual, fromExpected, to, timeFormatEnabled) => {
    const changeSpy = jest.fn();
    const dateFieldFilterType = new DateFieldFilterType_1.default(changeSpy, {}, { from: new Date(fromActual), to: new Date(to) }, { timeFormat: timeFormatEnabled });
    const dateFieldFilterTypeForm = (0, enzyme_1.mount)(dateFieldFilterType.getFormNode());
...
])('Call onChange handler with to value and existing value', (from, toActual, toExpected, timeFormatEnabled) => {
    const changeSpy = jest.fn();
    const dateFieldFilterType = new DateFieldFilterType_1.default(changeSpy, {}, { from: new Date(from), to: new Date(toActual) }, { timeFormat: timeFormatEnabled });
    const dateFieldFilterTypeForm = (0, enzyme_1.mount)(dateFieldFilterType.getFormNode());
