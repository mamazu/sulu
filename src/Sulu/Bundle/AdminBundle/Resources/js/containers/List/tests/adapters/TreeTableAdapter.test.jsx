...
test('Render data with schema', () => {
    ...
    const treeTableAdapter = (0, enzyme_1.render)(<TreeTableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} schema={schema}/>);
...
test('Render data without header', () => {
    ...
    const treeListAdapter = (0, enzyme_1.render)(<TreeTableAdapter_1.default {...listAdapterDefaultProps_1.default} adapterOptions={{ show_header: false }} data={data} page={1} pageCount={2} paginated={false} schema={schema}/>);
...
test('Render data with skin', () => {
    ...
    const treeListAdapter = (0, enzyme_1.render)(<TreeTableAdapter_1.default {...listAdapterDefaultProps_1.default} adapterOptions={{ skin: 'flat' }} data={data} page={1} pageCount={2} paginated={false} schema={schema}/>);
    expect(treeListAdapter).toMatchSnapshot();
});
test('Render data without header', () => {
    const test1 = {
...
test('Attach onClick handler for sorting if schema says the header is sortable', () => {
    ...
    const treeTableAdapter = (0, enzyme_1.shallow)(<TreeTableAdapter_1.default {...listAdapterDefaultProps_1.default} onSort={sortSpy} schema={schema}/>);
...
test('Render data with two columns', () => {
    ...
    const treeListAdapter = (0, enzyme_1.render)(<TreeTableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} schema={schema}/>);
    expect(treeListAdapter).toMatchSnapshot();
});
test('Render data with schema and selections', () => {
    ...
    const treeListAdapter = (0, enzyme_1.render)(<TreeTableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} schema={schema} selections={[1, 3]}/>);
    expect(treeListAdapter).toMatchSnapshot();
});
test('Execute onItemActivate respectively onItemDeactivate callback when an item is clicked', () => {
    ...
    const treeListAdapter = (0, enzyme_1.mount)(<TreeTableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} onItemActivate={onItemActivateSpy} onItemDeactivate={onItemDeactivateSpy} schema={schema}/>);
    // expand the row
...
test('Render data with pencil button and given itemActions when onItemEdit callback is passed', () => {
    ...
    const treeListAdapter = (0, enzyme_1.render)(<TreeTableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} 
    /* eslint-disable-next-line react/jsx-no-bind */
    itemActionsProvider={actionsProvider} onItemClick={jest.fn()} schema={schema}/>);
    expect(treeListAdapter).toMatchSnapshot();
});
test('Render correct buttons based on permissions when item permissions are provided', () => {
    ...
    const treeListAdapter = (0, enzyme_1.mount)(<TreeTableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} onItemAdd={jest.fn()} onItemClick={jest.fn()} schema={schema}/>);
...
test('Render disabled rows based on given disabledIds prop', () => {
    ...
    const treeListAdapter = (0, enzyme_1.mount)(<TreeTableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} disabledIds={[1, 3]} onItemAdd={jest.fn()} onItemClick={jest.fn()} schema={schema}/>);
...
test('Render data with plus button when onItemAdd callback is passed', () => {
    ...
    const treeListAdapter = (0, enzyme_1.render)(<TreeTableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} onItemAdd={jest.fn()} schema={schema}/>);
    expect(treeListAdapter).toMatchSnapshot();
});
test('Click on pencil should execute onItemClick callback', () => {
    ...
    const treeListAdapter = (0, enzyme_1.shallow)(<TreeTableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} onItemClick={rowEditClickSpy} schema={schema}/>);
...
test('Click on add should execute onItemAdd callback', () => {
    ...
    const treeListAdapter = (0, enzyme_1.shallow)(<TreeTableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} onItemAdd={rowAddClickSpy} schema={schema}/>);
    const buttons = treeListAdapter.find('Table').prop('buttons');
    expect(buttons).toHaveLength(1);
...
test('Click on itemAction should execute its callback', () => {
    ...
    const treeListAdapter = (0, enzyme_1.shallow)(<TreeTableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} itemActionsProvider={actionsProvider} onItemAdd={jest.fn()} schema={schema}/>);
...
test('Pagination should be passed correct props', () => {
    ...
    const data = [item1];
    const treeTableAdapter = (0, enzyme_1.shallow)(<TreeTableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} limit={10} onLimitChange={limitChangeSpy} onPageChange={pageChangeSpy} page={2} pageCount={7}/>);
...
test('Pagination should not be rendered if API is not paginated', () => {
    ...
    const pageChangeSpy = jest.fn();
    const limitChangeSpy = jest.fn();
    const treeTableAdapter = (0, enzyme_1.shallow)(<TreeTableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} onLimitChange={limitChangeSpy} onPageChange={pageChangeSpy} page={1} pageCount={undefined}/>);
    expect(treeTableAdapter.find('Pagination')).toHaveLength(0);
});
test('Pagination should not be rendered if no data is available', () => {
    const pageChangeSpy = jest.fn();
    const limitChangeSpy = jest.fn();
    const treeTableAdapter = (0, enzyme_1.shallow)(<TreeTableAdapter_1.default {...listAdapterDefaultProps_1.default} onLimitChange={limitChangeSpy} onPageChange={pageChangeSpy} page={1}/>);
    expect(treeTableAdapter.find('Pagination')).toHaveLength(0);
});
test('Pagination should not be rendered if pagination is false', () => {
    const treeTableAdapter = (0, enzyme_1.shallow)(<TreeTableAdapter_1.default {...listAdapterDefaultProps_1.default} limit={10} page={2} pageCount={7} paginated={false}/>);
    expect(treeTableAdapter.find('Pagination')).toHaveLength(0);
});
test('Next page should call onItemActiveate with undefined', () => {
    ...
    const onItemActivateSpy = jest.fn();
    const treeListAdapter = (0, enzyme_1.mount)(<TreeTableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} onItemActivate={onItemActivateSpy} onPageChange={onPageChangeSpy} page={1} pageCount={2} schema={schema}/>);
    // Click next page
