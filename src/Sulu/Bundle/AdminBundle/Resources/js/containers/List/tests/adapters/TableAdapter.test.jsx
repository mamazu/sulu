...
test('Render data with schema', () => {
    ...
    const tableAdapter = (0, enzyme_1.render)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} page={2} pageCount={5} schema={schema}/>);
    expect(tableAdapter).toMatchSnapshot();
});
test('Render data as icons', () => {
    listFieldTransformerRegistry_1.default.get.mockReturnValue(new IconFieldTransformer_1.default());
    const data = [
        {
            id: 1,
            status: 'planned',
    ...
    const tableAdapter = (0, enzyme_1.mount)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} page={1} pageCount={1} schema={schema}/>);
    ...
    expect(loglevel_1.default.warn).toBeCalledWith('There was no icon specified in the "mapping" transformer parameter for the value "running".');
...
test('Render data with skin', () => {
    ...
    const tableAdapter = (0, enzyme_1.render)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} adapterOptions={{
            skin: 'light',
        }} data={data} page={2} pageCount={5} schema={schema}/>);
    expect(tableAdapter).toMatchSnapshot();
});
...
test('Attach onClick handler for sorting if schema says the header is sortable', () => {
    ...
    const tableAdapter = (0, enzyme_1.shallow)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} onSort={sortSpy} schema={schema}/>);
...
test('Render data with schema and selections', () => {
    ...
    const tableAdapter = (0, enzyme_1.render)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} onItemSelectionChange={jest.fn()} page={1} pageCount={3} schema={schema} selections={[1, 3]}/>);
    expect(tableAdapter).toMatchSnapshot();
});
test('Render data with schema in different order', () => {
    ...
    const tableAdapter = (0, enzyme_1.render)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} page={2} pageCount={3} schema={schema}/>);
    expect(tableAdapter).toMatchSnapshot();
});
test('Render data with schema not containing all fields', () => {
    ...
    const tableAdapter = (0, enzyme_1.render)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} page={1} pageCount={3} schema={schema}/>);
    expect(tableAdapter).toMatchSnapshot();
});
test('Render data with pencil button when onItemEdit callback is passed', () => {
    ...
    const tableAdapter = (0, enzyme_1.render)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} onItemClick={jest.fn()} page={1} pageCount={3} schema={schema}/>);
    expect(tableAdapter).toMatchSnapshot();
});
test('Render correct button based on permissions when item permissions are provided', () => {
    ...
    const tableAdapter = (0, enzyme_1.mount)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} onItemClick={jest.fn()} page={1} pageCount={3} schema={schema}/>);
...
test('Render disabled rows based on given disabledIds prop', () => {
    ...
    const tableAdapter = (0, enzyme_1.mount)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} disabledIds={[1, 3]} onItemClick={jest.fn()} page={1} pageCount={3} schema={schema}/>);
...
test('Render data with pencil button and given itemActions when onItemEdit callback is passed', () => {
    ...
    const tableAdapter = (0, enzyme_1.render)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} 
    /* eslint-disable-next-line react/jsx-no-bind */
    itemActionsProvider={actionsProvider} onItemClick={jest.fn()} page={1} pageCount={3} schema={schema}/>);
    expect(tableAdapter).toMatchSnapshot();
});
test('Render column with ascending sort icon', () => {
    ...
    const tableAdapter = (0, enzyme_1.render)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} page={1} pageCount={3} schema={schema} sortColumn="title" sortOrder="asc"/>);
    expect(tableAdapter).toMatchSnapshot();
});
test('Render column with descending sort icon', () => {
    ...
    const tableAdapter = (0, enzyme_1.render)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} page={1} pageCount={3} schema={schema} sortColumn="description" sortOrder="desc"/>);
    expect(tableAdapter).toMatchSnapshot();
});
test('Click on pencil should execute onItemClick callback', () => {
    ...
    const tableAdapter = (0, enzyme_1.shallow)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} onItemClick={rowEditClickSpy} page={1} pageCount={3} schema={schema}/>);
...
test('Click on itemAction should execute its callback', () => {
    ...
    const tableAdapter = (0, enzyme_1.shallow)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} itemActionsProvider={actionsProvider} onItemClick={jest.fn()} page={1} pageCount={3} schema={schema}/>);
...
test('Click on checkbox should call onItemSelectionChange callback', () => {
    ...
    const tableAdapter = (0, enzyme_1.shallow)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} onItemSelectionChange={rowSelectionChangeSpy} page={1} pageCount={3} schema={schema}/>);
...
test('Click on checkbox in header should call onAllSelectionChange callback', () => {
    ...
    const tableAdapter = (0, enzyme_1.shallow)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} onAllSelectionChange={allSelectionChangeSpy} schema={schema}/>);
...
test('Pagination should be passed correct props', () => {
    ...
    const tableAdapter = (0, enzyme_1.shallow)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} limit={10} onLimitChange={limitChangeSpy} onPageChange={pageChangeSpy} page={2} pageCount={7}/>);
...
test('Pagination should not be rendered if API is not paginated', () => {
    ...
    const pageChangeSpy = jest.fn();
    const limitChangeSpy = jest.fn();
    const tableAdapter = (0, enzyme_1.shallow)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} data={data} onLimitChange={limitChangeSpy} onPageChange={pageChangeSpy} page={1} pageCount={undefined}/>);
    expect(tableAdapter.find('Pagination')).toHaveLength(0);
});
test('Pagination should not be rendered if no data is available', () => {
    const pageChangeSpy = jest.fn();
    const limitChangeSpy = jest.fn();
    const tableAdapter = (0, enzyme_1.shallow)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} onLimitChange={limitChangeSpy} onPageChange={pageChangeSpy} page={1}/>);
    expect(tableAdapter.find('Pagination')).toHaveLength(0);
});
test('Pagination should not be rendered if pagination is false', () => {
    const tableAdapter = (0, enzyme_1.shallow)(<TableAdapter_1.default {...listAdapterDefaultProps_1.default} limit={10} page={2} pageCount={7} paginated={false}/>);
    expect(tableAdapter.find('Pagination')).toHaveLength(0);
});
