...
function flattenData(items: Array<TreeItem>, data: Array<any> = []) {
...
function findRecursive(items: Array<any>, id: string | number): any | null | undefined {
    for (const item of items) {
...
function findSubTreeWithItemId(items: Array<any>, id: string | number): Array<any> | null | undefined {
    // TODO do not hardcode id but use metdata instead
...
function findChildrenForParentId(tree: Array<TreeItem>, parentId: string | null | undefined | number): Array<TreeItem> | null | undefined {
...
export default class TreeStructureStrategy implements StructureStrategyInterface {
    ...
    deactivate(id: string | null | undefined | number) {
