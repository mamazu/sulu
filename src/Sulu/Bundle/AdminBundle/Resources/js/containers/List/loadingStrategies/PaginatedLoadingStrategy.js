...
class PaginatedLoadingStrategy extends AbstractLoadingStrategy_1.default {
    // @deprecated
    constructor() {
        super();
        loglevel_1.default.warn('The "PaginatedLoadingStrategy" is deprecated since 2.1.9 and will be removed. ' +
...
exports.default = PaginatedLoadingStrategy;
