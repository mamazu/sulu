...
type Props = {
    ...
    adapterOptions?: {
        [adapterKey: string]: AdapterOptions
    },
    ...
    itemDisabledCondition?: string | null | undefined,
    movable: boolean,
    onCopyFinished?: (response: any) => void,
    onDeleteError?: (error?: any) => void,
    onItemAdd?: (id: string | null | undefined | number) => void,
...
class List extends React.Component<Props> {
    ...
    @observable
    currentAdapterKey: string;
    @observable
    showCopyOverlay: boolean = false;
    @observable
    showDeleteDialog: boolean = false;
    @observable
    showMoveOverlay: boolean = false;
    @observable
    showDeleteSelectionDialog: boolean = false;
    @observable
    allowConflictDeletion: boolean = true;
    @observable
    showOrderDialog: boolean = false;
    @observable
    adapterOptionsOpen: boolean = false;
    @observable
    columnOptionsOpen: boolean = false;
    @observable
    referencingResourcesData: ReferencingResourcesData | null | undefined = undefined;
    @observable
    dependantResourcesData: DependantResourcesData | null | undefined = undefined;
    @observable
    movingRestrictedTarget: any | null | undefined = undefined;
    resolveCopy: (arg1: ResolveCopyArgument) => void | null | undefined;
    resolveDelete: (arg1: ResolveDeleteArgument) => void | null | undefined;
    resolveMove: (arg1: ResolveMoveArgument) => void | null | undefined;
    resolveOrder: (arg1: ResolveOrderArgument) => void | null | undefined;
    moveId: string | null | undefined | number;
    ...
    static setAdapterSetting(listKey: string, userSettingsKey: string, value: any) {
        const key = [USER_SETTING_PREFIX, listKey, userSettingsKey, USER_SETTING_ADAPTER].join('.');
    ...
    @computed
    get currentAdapter(): typeof AbstractAdapter {
        return listAdapterRegistry.get(this.currentAdapterKey);
    }

    @computed
    get currentAdapterOptions(): typeof AbstractAdapter {
        return listAdapterRegistry.getOptions(this.currentAdapterKey);
    }

    @computed
    get disabledIds(): Array<string | number> {
        const {
            disabledIds,
    ...
    constructor(props: Props) {
        ...
        this.adapterDisposer = intercept(this, 'currentAdapterKey', (change: IValueWillChange<any>) => {
    ...
    @action handleDeleteResponseError = (response: any) => {
    ...
    @action handleMoveOverlayConfirmClick = (parent: any) => {
        if (!this.moveId) {
            throw new Error('The moveId is not set. This should not happen and is likely a bug.');
        }
    ...
    @action handleCopyOverlayConfirmClick = (parent: any) => {
        if (!this.resolveCopy) {
    ...
    handleItemActivate = (id: string | null | undefined | number) => {
