...
])('Throw error if "%s" is passed as a parameter', (parameters: any, errorMessage: any) => {
...
test('Return value node with a value', (done: any) => {
    const selectionFieldFilterType = new SelectionFieldFilterType(
        jest.fn(),
        {displayProperty: 'name', resourceKey: 'accounts'},
        undefined
    ...
    selectionFieldFilterType.selectionStore.getById.mockImplementation(function(id: any) {
        switch (id) {
            case 1:
