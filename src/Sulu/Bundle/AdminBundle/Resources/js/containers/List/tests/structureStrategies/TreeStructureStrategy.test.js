...
test('Should be empty after intialization', () => {
    const treeStructureStrategy = new TreeStructureStrategy_1.default();
    expect((0, mobx_1.toJS)(treeStructureStrategy.data.length)).toEqual(0);
});
...
test('Should only clear children under given parent', () => {
    ...
    expect((0, mobx_1.toJS)(treeStructureStrategy.data.length)).toEqual(1);
    expect((0, mobx_1.toJS)(treeStructureStrategy.data[0].children.length)).toEqual(0);
});
...
test('Should order item to given position', () => {
    ...
    expect((0, mobx_1.toJS)(treeStructureStrategy.data[0].children)).toEqual([item2, item1]);
});
test('Should order item to given position on first level', () => {
    ...
    treeStructureStrategy.data = data;
    treeStructureStrategy.order(5, 1);
    expect((0, mobx_1.toJS)(treeStructureStrategy.data)).toEqual([item2, item1]);
});
