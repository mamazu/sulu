...
jest.mock('sulu-admin-bundle/containers/Form/stores/MemoryFormStore', () => jest.fn((memoryStore: any) =>({memoryStore})));
...
jest.mock('../../../stores/userStore', () => {
    return new (class {
        ...
        getPersistentSetting(value: any) {
            return mockUserStoreGetPersistentSetting(value);
        }

        setPersistentSetting(name: any, value: any) {
            return mockUserStoreSetPersistentSetting(name, value);
        }
    });
});

jest.mock('../../ViewRenderer', () => (function Test(props: any) {
    return (
        <div>
            <h1>Test</h1>
