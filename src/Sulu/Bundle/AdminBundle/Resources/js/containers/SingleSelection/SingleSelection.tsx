...
type Props = {
    ...
    onChange: (
        selectedIds: string | null | undefined | number,
        selectedItem?: any | null | undefined,
    ) => void,
    onItemClick?: (id: number | null | undefined | string, item?: any | null | undefined) => void,
    overlayTitle: string,
    resourceKey: string,
...
class SingleSelection extends React.Component<Props> {
    ...
    constructor(props: Props) {
        ...
        this.changeDisposer = reaction(
            ...
            (loadedItemId: string | null | undefined | number) => {
    ...
    handleOverlayConfirm = (selectedItem: any) => {
