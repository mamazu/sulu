...
type Props = {
    ...
    meta?: string,
    mimeType: string,
    onClick?: (id: string | number, selected: boolean) => void | null | undefined,
    onDownload?: (url: string) => void,
    onSelectionChange?: (id: string | number, selected: boolean) => void | null | undefined,
    selected: boolean,
    showCover: boolean,
    title: string
};
...
class MediaCard extends React.Component<Props> {
    ...
    @observable
    downloadButtonRef: ElementRef<'button'> | null | undefined;
    @observable
    downloadListOpen: boolean = false;
    @observable
    ...
    @action setDownloadButtonRef = (ref?: ElementRef<'button'> | null) => {
    ...
    handleHeaderKeypress = (event: React.KeyboardEvent<HTMLElement>) => {
        const {
            id,
            selected,
            onSelectionChange,
