...
class MediaOverview extends React.Component<ViewProps> {
    ...
    collectionId: IObservableValue<number | null | undefined | string> = observable.box();
    @observable
    errors: Array<string> = [];
    @observable
    ...
    mediaList: ElementRef<typeof List> | null | undefined;
    @observable
    showMediaMoveOverlay: boolean = false;
    @observable
    showMediaUploadOverlay: boolean = false;
    @observable
    mediaMoving: boolean = false;
    disposer: () => void;
    ...
    @action handleCollectionNavigate = (collectionId: string | null | undefined | number) => {
        this.clearLists();
        this.mediaPage.set(1);
    ...
    @action handleUploadError = (errors: Array<any>) => {
        if (errors.length === 1) {
    ...
    setMediaListRef = (mediaList?: ElementRef<typeof List> | null) => {
    ...
    @action handleMoveMediaOverlayConfirm = (collection: any) => {
