...
jest.mock('sulu-admin-bundle/stores', () => ({
    ResourceStore: jest.fn(function(resourceKey: any, id: any, observableOptions: any) {
...
test('Promise returned by "update" method should be rejected if request has error status', (done: any) => {
    resourceRouteRegistry.getUrl.mockReturnValue('/media/1?action=new-version&locale=en');
...
test('Promise returned by "update" method should be rejected if request is not successful', (done: any) => {
    resourceRouteRegistry.getUrl.mockReturnValue('/media/1?action=new-version&locale=en');
