...
test('After loading the collection info should be set', (done: any) => {
...
test.each([true, false])('Should have a locked value of %s', (locked: any, done: any) => {
    ResourceRequester.get.mockReturnValue(Promise.resolve({
        id: 2,
        title: 'test',
        locked,
...
test('Should return an empty permission object if no permissions are given', (done: any) => {
    ResourceRequester.get.mockReturnValue(Promise.resolve({
        id: 2,
        title: 'test',
        _embedded: {
