...
const MediaFormatStore_1 = __importDefault(require("../MediaFormatStore"));
...
test('Load media formats', () => {
    ...
    const mediaFormatStore = new MediaFormatStore_1.default(4, 'de');
    expect(services_1.ResourceRequester.getList).toBeCalledWith('media_formats', { id: 4, locale: 'de' });
