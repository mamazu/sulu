...
type Props = {
    ...
    mediaListRef?: (arg1?: ElementRef<typeof List> | null | undefined) => void,
    ...
    onUploadError?: (errors: Array<any>) => void,
...
class MediaCollection extends React.Component<Props> {
    ...
    handleCollectionNavigate = (collectionId: string | null | undefined | number) => {
        this.props.onCollectionNavigate(collectionId);
    };

    @action handleUpload = (media: Array<any>) => {
    ...
    @action handleUploadError = (errorResponses: Array<any>) => {
