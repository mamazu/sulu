...
type Props = {
    ...
    onCollectionNavigate: (collectionId: string | null | undefined | number) => void,
...
class CollectionSection extends React.Component<Props> {
    @observable
    openedCollectionOperationOverlayType: OperationType;
    @observable
    movingRestrictedTargetCollection: any | null | undefined = undefined;
    @observable
    ...
    @computed
    get collectionId(): number | null | undefined | string {
    ...
    @computed
    get resourceStoreByOperationType(): ResourceStore {
    ...
    @action handleMoveCollectionConfirm = (collection: any) => {
        const {resourceStore} = this.props;
