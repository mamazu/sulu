...
const API_OPTIONS = {resourceKey: 'media'} as const;

@observer
class PermissionFormOverlay extends React.Component<Props> {
    @observable
    showInheritDialog: boolean = false;
    @observable
    error: string | null | undefined = undefined;
    permissionFormRef: Form | null | undefined;
    inheritDialogFormRef: Form | null | undefined;
    ...
    setPermissionFormRef = (permissionFormRef?: Form | null) => {
        this.permissionFormRef = permissionFormRef;
    };

    setInheritDialogFormRef = (inheritDialogFormRef?: Form | null) => {
    ...
    handleSubmitPermission = (options: string | null | undefined | {
        [key: string]: any
    }) => {
