...
jest.mock('sulu-admin-bundle/containers/Form/stores/ResourceFormStore', () =>jest.fn(function(resourceStore: any) {
...
jest.mock('sulu-admin-bundle/containers', () => {
    return {
        ...
        ListStore: jest.fn(function(resourceKey: any, userSettingsKey: any, observableOptions: any) {
            const COLLECTIONS_RESOURCE_KEY = 'collections';
...
jest.mock('sulu-admin-bundle/containers/List/registries/listAdapterRegistry', () => {
    ...
    return {
        getAllAdaptersMock,
        add: jest.fn(),
        get: jest.fn((key: any) => getAllAdaptersMock()[key]),
        getOptions: jest.fn().mockReturnValue({}),
        has: jest.fn(),
    };
});
...
jest.mock('sulu-admin-bundle/stores', () => {
    const ResourceStoreMock = jest.fn(function(resourceKey: any) {
...
test.each([true, false])('Pass correct hasChildren "%s" option to PermissionFormOverlay', (hasChildren: any) => {
    const page = observable.box();
    const locale = observable.box();
    const ListStore = require('sulu-admin-bundle/containers').ListStore;
    const mediaListStore = new ListStore(
