...
const MediaCardAdapter_1 = __importDefault(require("../../adapters/MediaCardAdapter"));
...
test('Render a basic Masonry view with MediaCards', () => {
    ...
    const mediaCardAdapter = (0, enzyme_1.render)(<MediaCardAdapter_1.default {...TestHelper_1.listAdapterDefaultProps} data={data} icon="su-pen" onItemSelectionChange={jest.fn()} page={1} pageCount={7}/>);
...
test('AdminUrl should fallback to url on undefined', () => {
    ...
    const mediaCardAdapter = (0, enzyme_1.shallow)(<MediaCardAdapter_1.default {...TestHelper_1.listAdapterDefaultProps} data={data} icon="su-pen" onItemSelectionChange={jest.fn()} page={1} pageCount={7}/>);
...
test('MediaCard should call the the appropriate handler', () => {
    ...
    const mediaCardAdapter = (0, enzyme_1.shallow)(<MediaCardAdapter_1.default {...TestHelper_1.listAdapterDefaultProps} data={data} icon="su-pen" onItemClick={mediaCardSelectionChangeSpy} onItemSelectionChange={mediaCardSelectionChangeSpy} page={3} pageCount={9}/>);
...
test('InfiniteScroller should be passed correct props', () => {
    ...
    const tableAdapter = (0, enzyme_1.shallow)(<MediaCardAdapter_1.default {...TestHelper_1.listAdapterDefaultProps} icon="su-pen" loading={false} onPageChange={pageChangeSpy} page={2} pageCount={7}/>);
