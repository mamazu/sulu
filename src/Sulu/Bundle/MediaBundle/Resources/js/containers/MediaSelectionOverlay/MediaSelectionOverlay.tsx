...
type Props = {
    collectionId: IObservableValue<string | null | undefined | number>,
    collectionListStore: ListStore,
    confirmLoading: boolean,
    locale: IObservableValue<string>,
    mediaListStore: ListStore,
    onClose: () => void,
    onConfirm: (selectedMedia: Array<any>) => void,
    open: boolean
};
...
class MediaSelectionOverlay extends React.Component<Props> {
    ...
    static createMediaListStore(
        collectionId: IObservableValue<string | null | undefined | number>,
        excludedIds: IObservableValue<Array<number> | null | undefined>,
        locale: IObservableValue<string>,
    ...
    @action updateCollectionStore(collectionId: string | null | undefined | number) {
        if (this.collectionStore) {
            this.collectionStore.destroy();
        }
