...
class CropOverlay extends React.Component<Props> {
    @observable
    rawFormats: Array<any> | null | undefined;
    @observable
    formatKey: string | null | undefined;
    @observable
    changedFormatCroppings: Map<string, any> = new Map();
    @observable
    dirty: boolean;
    ...
    @computed
    get availableFormats(): Array<any> {
        if (!this.rawFormats) {
            return [];
        }
    ...
    convertSelectionToFormatOptions(selection?: SelectionData | null) {
        if (!selection) {
            return {};
        }
    ...
    convertFormatOptionsToSelection(formatOption?: MediaFormat | null) {
        if (!formatOption) {
            return undefined;
        }
    ...
    @action handleSelectionChange = (currentSelection: any) => {
        const {formatKey} = this;
