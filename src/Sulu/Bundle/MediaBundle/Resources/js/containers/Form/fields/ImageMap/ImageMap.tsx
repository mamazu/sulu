...
class ImageMap extends React.Component<FieldTypeProps<Value>> {
    ...
    getHotspotFormSchemaType = (type?: string | null) => {
    ...
    handleHotspotFormChange = (index: number, name: string, value: any) => {
        const {onChange} = this.props;
    ...
    renderHotspotForm: RenderHotspotFormCallback = (value: any, type: string, index: number) => {
        const {
            data,
            dataPath,
            error,
    ...
    render() {
        ...
        const formTypes = Object.keys(types).reduce<Record<string, any>>((formTypes, current) => {
