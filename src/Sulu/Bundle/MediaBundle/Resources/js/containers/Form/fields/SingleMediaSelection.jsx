    ...
    var SingleMediaSelection = _classThis = class extends _classSuper {
        ...
        get value() {
            ...
            if (value && typeof value !== 'object') {
                throw new Error('The "SingleMediaSelection" field with the path "' + dataPath + '" expects an object with an "id" '
        ...
        render() {
            ...
            const { displayOptions: { value: displayOptions, } = {}, types: { value: mediaTypes, } = {}, } = schemaOptions;
            ...
            return (<SingleMediaSelection_1.default disabled={!!disabled} displayOptions={displayOptionValues} locale={locale} onChange={this.handleChange} onItemClick={this.handleItemClick} types={mediaTypeValues} valid={!error} value={this.value ? this.value : undefined}/>);
        }
    };
