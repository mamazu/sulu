...
class FieldRenderer extends react_1.default.Component {
    ...
    render() {
        ...
        return (<containers_1.Renderer data={data} dataPath={dataPath} errors={errors} formInspector={formInspector} onChange={this.handleChange} onFieldFinish={onFieldFinish} onSuccess={onSuccess} router={router} schema={schema} schemaPath={schemaPath} showAllErrors={showAllErrors} value={value}/>);
    }
}
