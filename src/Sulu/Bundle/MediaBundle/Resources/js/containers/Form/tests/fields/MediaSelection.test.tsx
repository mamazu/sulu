...
jest.mock('sulu-admin-bundle/stores/ResourceStore', () => jest.fn(function(resourceKey: any, id: any, observableOptions: any) {
...
jest.mock('sulu-admin-bundle/containers/Form/FormInspector', () => jest.fn(function(formStore: any) {
...
test('Should throw an error if given value does not have an ids property', () => {
    ...
    expect(() => shallow(
        <MediaSelection
            {...fieldTypeDefaultProps}
            formInspector={formInspector}
            value={({unrelatedProperty: 123} as any)}
        />
...
test('Should log warning and use ids of objects if given value is an array of objects', () => {
    ...
    const mediaSelection = shallow(
        <MediaSelection
            ...
            disabled={true}
            formInspector={formInspector}
            value={([{id: 55}, {id: 66}, {id: 77}] as any)}
        />
    );
