...
type Props = {
    ...
    onFinish?: () => void,
    onSelectionChange: (index: number, selection: any) => void,
...
class ImageRenderer extends React.Component<Props> {
    ...
    imageWrapperRef: ElementRef<'div'> | null | undefined;
    ...
    setImageWrapperRef = (ref?: ElementRef<'div'> | null) => {
    ...
    getCommonSelectionProps = (hotspot: Hotspot, index: number) => {
        ...
        const entries = Object.entries(hotspot.hotspot).filter(([key]: [any]) => key !== 'type');
        const value: any | typeof undefined = entries.length !== 0 ? Object.fromEntries(entries) : undefined;
        ...
        return (
            <div className={imageRendererStyles.imageRenderer}>
                <div className={imageRendererStyles.imageRendererWrapper} ref={this.setImageWrapperRef}>
                    ...
                    {this.sortedHotspots.map(([index, hotspotData]: [any, any]) => {
