...
type Props = {
    ...
    children: Node,
    className?: string,
    collectionId: string | null | undefined | number,
    disabled: boolean,
    locale: IObservableValue<string>,
    onClose: () => void,
    onOpen: () => void,
    onUpload: (media: Array<any>) => void,
...
class MultiMediaDropzone extends React.Component<Props> {
    ...
    @observable
    filesScheduledForUpload: Array<File> = [];
    @observable
    mediaUploadStores: Array<MediaUploadStore> = [];
    ...
    @action handleSelectCollectionOverlayConfirm = (collection: any) => {
