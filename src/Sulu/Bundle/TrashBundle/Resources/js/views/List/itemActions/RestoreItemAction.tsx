...
export default class RestoreItemAction extends AbstractListItemAction {
    static restoreConfigurationMapping: {
        [resourceKey: string]: RestoreConfiguration
    } = {};

    @observable
    idToBeRestored: string | null | undefined | number = undefined;
    @observable
    resourceKeyToBeRestored: string | null | undefined = undefined;
    @observable
    restoring: boolean = false;

    @computed
    get restoreConfiguration(): RestoreConfiguration | null | undefined {
    ...
    getItemActionConfig(item?: any | null) {
        return {
            icon: 'su-process',
