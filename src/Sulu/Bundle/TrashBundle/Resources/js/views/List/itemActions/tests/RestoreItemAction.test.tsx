...
jest.mock('sulu-admin-bundle/containers/List/stores/ListStore', () => jest.fn(function(resourceKey: any) {
...
jest.mock('../../../../containers/RestoreFormOverlay', () => (class RestoreFormOverlay extends mockReact.Component<any> {
    render() {
