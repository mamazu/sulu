...
jest.mock('sulu-admin-bundle/containers/Form/FormInspector', () => jest.fn(function(resourceFormStore: any) {
...
jest.mock(
    ...
    () => jest.fn(function(resourceKey: any, id: any, observableOptions: any, options: any) {
