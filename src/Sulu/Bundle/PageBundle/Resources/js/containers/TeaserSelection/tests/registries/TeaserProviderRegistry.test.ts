...
test('Clear all teaserProviders', () => {
    const teaserProviderOptions = {...defaultTeaserProviderOptions} as const;
...
test('Add teaserProvider', () => {
    const teaserProviderOptions1 = {...defaultTeaserProviderOptions} as const;
    const teaserProviderOptions2 = {...defaultTeaserProviderOptions} as const;
