...
class Item extends React.Component<Props> {
    static mediaUrl: string | null | undefined = undefined;
    ...
    @observable
    mediaId: number | null | undefined = undefined;
    @observable
    mediaOverlayOpen: boolean = false;
    ...
    @action handleDescriptionChange = (description?: string | null) => {
        this.description = description;
    };
