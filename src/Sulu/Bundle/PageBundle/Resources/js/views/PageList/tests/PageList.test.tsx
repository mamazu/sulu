...
jest.mock('sulu-admin-bundle/containers', () => ({
    ...
    ListStore: class {
        ...
        constructor(resourceKey: any, listKey: any, userSettingsKey: any, observableOptions: any) {
    ...
    withToolbar: jest.fn((Component: any) => Component),
}));
...
test('Should use CacheClearToolbarAction for cache clearing', () => {
    ...
    const cacheClearToolbarAction: CacheClearToolbarAction = (CacheClearToolbarAction as any).mock.instances[0];
