...
class PageList extends React.Component<Props> {
    ...
    @observable
    availablePageTypes: Array<string> = [];
    @observable
    availablePageTypesLoading: boolean = true;
    @observable errors = [];
    ...
    findDefaultLocale = (localizations: Array<Localization>): string | null | undefined => {
    ...
    constructor(props: Props) {
        ...
        const requestParameters = {webspace} as const;
        ...
        formMetadataStore.getSchemaTypes('page', {webspace, onlyKeys: true}).then(action((schemaTypes: any) => {
    ...
    handleItemAdd = (id: string | null | undefined | number) => {
        const {router} = this.props;
        router.navigate(
    ...
    handleCopyFinished = (response: any) => {
