...
jest.mock(
    ...
    () => jest.fn(function(resourceStore: any, formKey: any, options: any) {
...
test('Pass system prop correctly to component', () => {
    ...
    webspaceStore.getWebspace.mockImplementation((webspaceKey: any) => {
        if (webspaceKey === 'test') {
            return {
                key: 'test',
                security: {
    ...
    webspaceStore.hasWebspace.mockImplementation((webspaceKey: any) => {
        if (webspaceKey === 'test') {
            return true;
        }
    });
