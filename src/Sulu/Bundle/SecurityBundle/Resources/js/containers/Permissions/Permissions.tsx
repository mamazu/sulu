...
class Permissions extends React.Component<Props> {
    ...
    @computed
    get webspaceContextPermissionPrefix(): string {
    ...
    @computed
    get webspaceSecurityContextGroupKey(): string | null | undefined {
    ...
    @computed
    get selectedWebspaces(): Array<string> {
