...
type Props = FieldTypeProps<PageTreeRouteValue | null | undefined>;
...
class PageTreeRoute extends Component<Props> {
    ...
    get pageValue(): string | null | undefined {
    ...
    get suffixValue(): string | null | undefined {
        const {value} = this.props;
    ...
    handleSuffixChange = (value?: string | null): void => {
        this.handleChange({
            ...this.props.value,
            suffix: value,
        });
    ...
    handleChange = (value?: PageTreeRouteValue | null) => {
