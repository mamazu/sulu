...
test('Render a list of rules', () => {
    ruleRegistry.get.mockImplementation((key: any) => {
        switch (key) {
            case 'browser':
                return {
                    name: 'Browser',
...
test('Edit an existing rule', () => {
    ...
    ruleRegistry.get.mockImplementation((key: any) => ruleRegistry.getAll()[key]);

    ruleTypeRegistry.get.mockImplementation((type: any) => {
        switch (type) {
            case 'select':
                return SingleSelect;
            case 'key_value':
