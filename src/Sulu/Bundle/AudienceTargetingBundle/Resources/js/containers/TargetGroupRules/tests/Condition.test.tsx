...
test('Render a condition', () => {
    ...
    const value = {condition: {}, type: 'browser'} as const;
...
test('Call onRemove callback if remove icon is clicked', () => {
    ...
    const value = {condition: {}, type: undefined} as const;
...
test('Call onChange callback if rule type changes', () => {
    ...
    const value = {condition: {test: 'value'}, type: undefined} as const;
...
test('Call onChange callback if condition changes', () => {
    ...
    const RuleType = () => null;
    ruleTypeRegistry.get.mockImplementation((key: any) => {
        switch (key) {
            case 'select':
                return RuleType;
        }
