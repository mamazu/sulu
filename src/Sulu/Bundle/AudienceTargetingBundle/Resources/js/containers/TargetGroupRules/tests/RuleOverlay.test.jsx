...
test('Render RuleOverlay without value', () => {
    const ruleOverlay = (0, enzyme_1.mount)(<RuleOverlay_1.default onClose={jest.fn()} onConfirm={jest.fn()} open={true} value={undefined}/>);
...
test('Write passed values to input, single select and condition list when overlay is opened', () => {
    ...
    const ruleOverlay = (0, enzyme_1.shallow)(<RuleOverlay_1.default onClose={jest.fn()} onConfirm={jest.fn()} open={false} value={{ conditions, frequency: 2, title: 'Rule 1' }}/>);
...
test('Call confirm with the current values', () => {
    ...
    const ruleOverlay = (0, enzyme_1.shallow)(<RuleOverlay_1.default onClose={jest.fn()} onConfirm={confirmSpy} open={true} value={undefined}/>);
...
test('Call onClose callback when overlay is closed', () => {
    ...
    const ruleOverlay = (0, enzyme_1.shallow)(<RuleOverlay_1.default onClose={closeSpy} onConfirm={jest.fn()} open={true} value={undefined}/>);
