...
class TargetGroupRules extends React.Component<Props> {
    ...
    @observable
    ruleIndex: number | typeof undefined = undefined;
    @observable
    ...
    @action handleAllSelectionChange = (checked?: boolean | null) => {
        if (!checked) {
            this.selectedIndices.splice(0, this.selectedIndices.length);
        } else {
    ...
    @action handleSelectionChange = (id: number, checked?: boolean | null) => {
