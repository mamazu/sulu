...
test('Load accounts and contacts', () => {
    ...
    const contact1 = {id: 1, fullName: 'Max Mustermann'} as const;
    const contact3 = {id: 3, fullName: 'John Doe'} as const;
    const account1 = {id: 1, name: 'Sulu'} as const;
    const account5 = {id: 5, name: 'Example company'} as const;
    ...
    ResourceRequester.getList.mockImplementation((resourceKey: any) => {
...
test('Do not send any requests if nothing has to be loaded', (done: any) => {
    const contactAccountSelectionStore = new ContactAccountSelectionStore();
...
test('Send only contact request if nothing has to be loaded', (done: any) => {
    const contactAccountSelectionStore = new ContactAccountSelectionStore();
...
test('Send only accounts request if nothing has to be loaded', (done: any) => {
    const contactAccountSelectionStore = new ContactAccountSelectionStore();
