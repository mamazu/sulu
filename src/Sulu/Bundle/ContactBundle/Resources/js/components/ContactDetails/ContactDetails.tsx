...
class ContactDetails extends React.Component<Props> {
    ...
    updateValue = (type: string, index: number, property: string, updatedValue: string | null | undefined | number) => {
    ...
    handleEmailChange = (index: number, email?: string | null) => {
        this.updateValue('emails', index, 'email', email);
    };

    handlePhoneChange = (index: number, phone?: string | null) => {
        this.updateValue('phones', index, 'phone', phone);
    };

    handleWebsiteChange = (index: number, website?: string | null) => {
        this.updateValue('websites', index, 'website', website);
    };

    handleFaxChange = (index: number, fax?: string | null) => {
        this.updateValue('faxes', index, 'fax', fax);
    };

    handleUsernameChange = (index: number, username?: string | null) => {
