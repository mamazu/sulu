...
const AnalyticsDomainSelect_1 = __importDefault(require("../../fields/AnalyticsDomainSelect"));
...
test('Pass correct props to MultiSelect', () => {
    ...
    const analyticsDomainSelect = (0, enzyme_1.shallow)(<AnalyticsDomainSelect_1.default {...TestHelper_1.fieldTypeDefaultProps} disabled={true} formInspector={formInspector} value={['{host}']}/>);
...
test('Call onChange and onBlur if the value is changed', () => {
    ...
    stores_2.webspaceStore.getWebspace.mockReturnValue(webspace);
    const analyticsDomainSelect = (0, enzyme_1.shallow)(<AnalyticsDomainSelect_1.default {...TestHelper_1.fieldTypeDefaultProps} formInspector={formInspector} onChange={changeSpy} onFinish={finishSpy} value={['{host}']}/>);
