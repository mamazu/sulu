...
jest.mock('../stores/PreviewStore', () => jest.fn(function(resourceKey: any, id: any, locale: any) {
...
test('Render popover when no link is available', (done: any) => {
