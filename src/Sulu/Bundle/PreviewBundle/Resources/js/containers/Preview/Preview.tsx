...
class Preview extends React.Component<Props> {
    ...
    @observable
    targetGroupsStore: ResourceListStore | null | undefined;
    ...
    previewWindow: any;
    @observable
    webspaceOptions: Array<any> = [];
    @observable
    reloadCounter: number = 0;

    schemaDisposer: () => unknown;
    dataDisposer: () => unknown;
    localeDisposer: () => unknown;
    ...
    constructor(props: Props) {
        ...
        this.webspaceOptions = webspaceStore.grantedWebspaces.map((webspace): any => ({
            label: webspace.name,
            value: webspace.key,
        }));
    ...
    updatePreview = debounce((data: any) => {
    ...
    getPreviewWindow = (): any | null | undefined => {
        if (this.previewWindow) {
    ...
    getPreviewScrollPosition = (): number | null | undefined => {
    ...
    @action setIframe = (iframeRef?: any | null) => {
    ...
    @action handleDateTimeChange = debounce((value?: Date | null) => {
    ...
    handleSegmentChange = (segmentKey?: string | null) => {
        const {formStore} = this.props;
