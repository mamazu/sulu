...
let CustomUrlsDomainSelect = (() => {
    ...
    var CustomUrlsDomainSelect = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
        ...
        render() {
            ...
            return (<components_1.SingleSelect disabled={!!disabled} onChange={this.handleChange} value={value}>
                {this.webspace.customUrls.map(({ url }) => (<components_1.SingleSelect.Option key={url} value={url}>
                        {url}
                    </components_1.SingleSelect.Option>))}
            </components_1.SingleSelect>);
        }
    };
    __setFunctionName(_classThis, "CustomUrlsDomainSelect");
    (() => {
        var _a;
        ...
        CustomUrlsDomainSelect = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CustomUrlsDomainSelect = _classThis;
})();
exports.default = CustomUrlsDomainSelect;
