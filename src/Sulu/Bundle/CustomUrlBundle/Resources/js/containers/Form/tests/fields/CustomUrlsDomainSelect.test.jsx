...
const CustomUrlsDomainSelect_1 = __importDefault(require("../../fields/CustomUrlsDomainSelect"));
...
test('Pass correct props to MultiSelect', () => {
    ...
    const customUrlsDomainSelect = (0, enzyme_1.shallow)(<CustomUrlsDomainSelect_1.default {...TestHelper_1.fieldTypeDefaultProps} disabled={true} formInspector={formInspector} value="www.sulu.io/*"/>);
...
test('Call onChange and onBlur if the value is changed', () => {
    ...
    stores_2.webspaceStore.getWebspace.mockReturnValue(webspace);
    const customUrlsDomainSelect = (0, enzyme_1.shallow)(<CustomUrlsDomainSelect_1.default {...TestHelper_1.fieldTypeDefaultProps} formInspector={formInspector} onChange={changeSpy} onFinish={finishSpy} value="www.sulu.io/*"/>);
