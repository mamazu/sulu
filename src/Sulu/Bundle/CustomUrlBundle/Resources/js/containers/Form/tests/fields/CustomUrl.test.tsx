...
jest.mock('sulu-admin-bundle/containers', () => ({
    FormInspector: jest.fn(function(resourceFormStore: any) {
        this.id = resourceFormStore.id;
        this.options = resourceFormStore.options;
        this.getValueByPath = jest.fn();
    }),
    ResourceFormStore: jest.fn(function(formStore: any, formKey: any, options = {}) {
...
jest.mock('sulu-admin-bundle/stores', () => ({
    ResourceStore: jest.fn(function(resourceKey: any, id: any) {
        this.id = id;
    }),
}));
