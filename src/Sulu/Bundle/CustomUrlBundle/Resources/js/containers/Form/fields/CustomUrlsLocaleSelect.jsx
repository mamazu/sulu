...
let CustomUrlsLocaleSelect = (() => {
    ...
    var CustomUrlsLocaleSelect = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
        ...
        render() {
            ...
            return (<components_1.SingleSelect disabled={!!disabled} onChange={this.handleChange} value={value}>
                {this.webspace.allLocalizations.map(({ localization }) => (<components_1.SingleSelect.Option key={localization} value={localization}>
                        {localization}
                    </components_1.SingleSelect.Option>))}
            </components_1.SingleSelect>);
        }
    };
    __setFunctionName(_classThis, "CustomUrlsLocaleSelect");
    (() => {
        var _a;
        ...
        CustomUrlsLocaleSelect = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CustomUrlsLocaleSelect = _classThis;
})();
exports.default = CustomUrlsLocaleSelect;
